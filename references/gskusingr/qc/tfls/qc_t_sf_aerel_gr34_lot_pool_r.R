####------------------------------------------------------------------------####
# Program Name: qc_t_sf_aerel_gr34_lot_pool_r.R
...
adae_1 <- convert_blanks_to_na(adae) |>
  filter(SAFFL == "Y", TRTEMFL == "Y" & (ATOXGRN==3 | ATOXGRN==4) & AREL == "Related") |>
...
prod <- read_parquet(file.path(g_paths$dddata, "t_sf_aerel_gr34_lot_pool_r.parquet")) |>
