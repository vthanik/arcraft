####------------------------------------------------------------------------####
# Program Name: qc_t_sf_aeserrel_lot_pool_r.R
# Domino Environment: Multilingual Frozen R4.5.1_2025-09-09_v1 SASViya4
# Developer: Shilpa Kolli / sk575206
# Purpose: Summary of IDRX-42-related Serious Treatment-Emergent Adverse Events by 
...
prod <- read_parquet(file.path(g_paths$dddata, "t_sf_aeserrel_lot_pool_r.parquet")) |>
