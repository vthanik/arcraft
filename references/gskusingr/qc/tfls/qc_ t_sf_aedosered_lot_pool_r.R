####------------------------------------------------------------------------####
# Program Name: qc_t_sf_aedosered_lot_pool_r.R
# Domino Environment: Multilingual Frozen R4.5.1_2025-09-09_v1 SASViya4
# Developer: Pragya Tripathi / ps209009
# Purpose: Summary of Treatment-Emergent Adverse Event Leading to IDRX-42 Dose Reduced 
...
adae_1 <- convert_blanks_to_na(adae) |>
  filter(SAFFL == "Y", TRTEMFL == "Y" & 
           (AEACN=="DOSE REDUCED" | AEACN2=="DOSE REDUCED" |AEACN3=="DOSE REDUCED")) |>
...
prod <- read_parquet(file.path(g_paths$dddata, "t_sf_aedosered_lot_pool_r.parquet")) |>
