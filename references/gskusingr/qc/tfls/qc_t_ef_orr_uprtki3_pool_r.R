####------------------------------------------------------------------------####
# Program Name: qc_t_ef_orr_uprtki3_pool_r
# Domino Project: 61834_300382_INTERNAL_03
# Domino Environment: Multilingual Frozen R4.5.0_2025-06-03v1 SASViya4
# Developer: Mariam ALaverdyan/ ma584118
# Purpose: QC t_ef_orr_uprtki3_pool_r
# Input: ADSL ADEFF
# Output: [N/A]
...
#
qc_t_ef_orr_uprtki3_pool_r <- ard_tbl1 |>
...
t_ef_orr_uprtki3_pool_r <- t_ef_orr_uprtki3_pool_r |>
  arrange(column, stat_name, LABEL, GROUP) |>
  select(-ord_2)

# Compare PRODUCTION vs QC datasets ----
diffdf::diffdf(
  base = t_ef_orr_uprtki3_pool_r,
  compare = qc_t_ef_orr_uprtki3_pool_r
)