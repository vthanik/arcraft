####------------------------------------------------------------------------####
# Program Name: t_sf_aeser_pool_r.R
# Domino Environment: Multilingual Semi-Frozen R4.5.1_2025-09-09_v1 SASViya4
# Developer: Pragya Tripathi / ps209009
# Purpose: Summary of Treatment-Emergent Serios Adverse Events by System Organ Class
#          and Preferred Term (Phase 1 & 1b pooled)
#
# Input:
#   - adam: adbs, adae
# Output:
#   - dd: t_sf_aeser_pool_r.parquet
#   - File: ../prod/output/t_sf_aeser_pool_r.RTF
#
...
write_parquet(
  final_ard,
  file.path(g_paths$dddata, "t_sf_aeser_pool_r.parquet")
)
...
rtf_obj <- gt |>
  ...
  build_rtf(
    file = file.path(g_paths$output, "t_sf_aeser_pool_r.rtf")
  )