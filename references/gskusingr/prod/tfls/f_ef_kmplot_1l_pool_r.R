####------------------------------------------------------------------------####
# Program Name: f_ef_kmplot_1l_pool_r.R
# Domino Environment: Multilingual Frozen R4.5.1_2025-09-09_v1 SASViya4
# Developer: Vignesh Thanikachalam / vt704670
# Purpose:  Kaplan-Meier Plot for Progression-free Survival (2nd Line of Therapy)
# (Phase 1 & 1b pooled)
#
# Input:
#   - ADAM: ADBS, ADTR, ADEFF
# Output:
#   - File: ../prod/output/f_ef_kmplot_1l_pool_r.rtf
#
...
rtf_obj <- survplot |>
  ...
  rtf_title(
    "Figure 14.2.2f",
    "Kaplan-Meier Plot for Progression-free Survival in 1st Line of Therapy (Phase 1 & 1b pooled)"
  ) |>
  rtf_header(
  ...
  build_rtf(
    file = file.path(g_paths$output, "f_ef_kmplot_1l_pool_r.rtf")
  )