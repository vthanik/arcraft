####------------------------------------------------------------------------####
# Program Name: t_ef_cbr_uprtki1_pool_r.R
...
# Purpose: To create Table 14.2.1.1.2.1c  -  Summary of Clinical Benefit Rate in Subjects with Prior Bezuclastinib, NB003,
...
rtf_dt |>
  build_rtf(file = file.path(g_paths$output, "t_ef_cbr_uprtki1_pool_r.rtf"))


# Write out ARD to parquet file
write_parquet(df_borci,file.path(g_paths$dddata, "t_ef_cbr_uprtki1_pool_r.parquet"))

#Reading parquet file
t_ef_cbr_uprtki1_pool_r <- read_parquet(file.path(g_paths$dddata,"t_ef_cbr_uprtki1_pool_r.parquet"))