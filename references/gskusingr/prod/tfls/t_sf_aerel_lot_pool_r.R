####------------------------------------------------------------------------####
# Program Name: t_sf_aerel_lot_pool_r.R
# Domino Environment: Multilingual Frozen R4.5.1_2025-09-09_v1 SASViya4
# Developer: Shilpa Kolli / sk575206
# Purpose: Table 14.3.2.2e Summary of IDRX-42-related Treatment-Emergent Adverse Events by System Organ Class and
# Preferred Term by line of therapy subgroup (Phase 1 & 1b pooled)
#
# Input:
#   - ADaM: adbs, adae
# Output:
#   - DD: t_sf_aerel_lot_pool_r.parquet
#   - File: ../prod/output/t_sf_aerel_lot_pool_r.RTF
#
...
arrow::write_parquet(
  final_ard,
  file.path(g_paths$dddata, "t_sf_aerel_lot_pool_r.parquet")
)
...
rtf_obj <- gt |>
  ...
  build_rtf(
    file = file.path(g_paths$output, "t_sf_aerel_lot_pool_r.rtf")
  )
