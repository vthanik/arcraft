####------------------------------------------------------------------------####
# Program Name: t_sf_aeoverall_pool.R
...
# Purpose: Table 14.3.1.1c-Overall Summary of Treatment Emergent Adverse Events
...
write_parquet(
  all_ard_2,
  file.path(g_paths$dddata, "t_sf_aeoverall_pool_r.parquet")
)
...
rtf_obj <- gt |>
  ...
  rtf_title(
    "Table 14.3.1.1c",
    "Overall Summary of Treatment Emergent Adverse Events by 1st and 2nd Line of Therapy",
    "(Phase 1 & 1b pooled)"
  ) |>
  rtf_header(
...
rtf_obj |>
  build_rtf(file = file.path(g_paths$output, "t_sf_aeoverall_pool_r.rtf"))
