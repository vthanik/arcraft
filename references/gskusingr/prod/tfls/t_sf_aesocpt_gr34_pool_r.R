####------------------------------------------------------------------------####
# Program Name: t_sf_aesocpt_gr34_pool_r.R
...
#   - ADaM: ADBS, ADAE
# Output:
#   - DD: t_sf_aesocpt_gr34_pool_r.parquet
#   - File: ../prod/output/t_sf_aesocpt_gr34_pool_r.RTF
#
...
arrow::write_parquet(
  final_ard,
  file.path(g_paths$dddata, "t_sf_aesocpt_gr34_pool_r.parquet")
)
...
rtf_obj <- gt |>
  ...
  build_rtf(
    file = file.path(g_paths$output, "t_sf_aesocpt_gr34_pool_r.rtf")
  )
