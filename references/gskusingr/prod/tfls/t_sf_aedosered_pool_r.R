####------------------------------------------------------------------------####
# Program Name: t_sf_aedosered_pool_r.R
# Domino Environment: Multilingual Frozen R4.5.1_2025-09-09_v1 SASViya4
# Developer: Shilpa Kolli / sk575206
# Purpose: Table 14.3.2.11c Summary of Treatment-Emergent Adverse Events Leading to IDRX-42 Dose 
# Reduced by System Organ Class and Preferred Term (Phase 1 & 1b pooled)
#
# Input:
#   - ADaM: ADBS, ADAE
# Output:
#   - DD: t_sf_aedosered_pool_r.parquet
#   - File: ../prod/output/t_sf_aedosered_pool_r.RTF
#
...
arrow::write_parquet(
  final_ard,
  file.path(g_paths$dddata, "t_sf_aedosered_pool_r.parquet")
)
...
rtf_obj <- gt |>
  ...
  build_rtf(
    file = file.path(g_paths$output, "t_sf_aedosered_pool_r.rtf")
  )
