...
| Date:             10DEC2004
|
| Macro Purpose:    A macro to create IDSL standard display DM6
|
...
|                     summarised.
|
| PSFORMAT            Passed to the PROC SUMMARY FORMAT statement. The  raceccd $racesl.
...
|                     in &dsetinnumer
|
| RACEFMT             Specify format which represents the highest       $racesl
|                     level race categories and racial combinations
|                     Valid Values:
...
%macro td_dm6(
   ...
   DDDATASETLABEL      =DD dataset for table DM6, /* Label to be applied to the DD dataset */
   ...
   PSFORMAT            =raceccd $racesl.,  /* Passed to the PROC SUMMARY FORMAT statement. */
   ...
   RACEFMT             =$racesl,           /* Format for &RACECCDVAR */
   ...
   %local l_prefix l_var_len l_cdvar_len l_rc l_varprefix ; 
   ...
   /*
   / Modify value of &RACECCDVAR to contain only second-level race categories 
   /--------------------------------------------------------------------------*/
   data &l_prefix.mod1;
      set &dsetinnumer ;
      ...
      when ('13')  &raceccdvar='03'; 
      when ('14')  &raceccdvar='04'; 
      when ('15')  &raceccdvar='05'; 
      when ('16')  &raceccdvar='06';     
      when ('17')  &raceccdvar='08';  
      when ('18')  &raceccdvar='09';     
      when ('19')  &raceccdvar='10';     
      otherwise;
      end;              
   run;
   ...
   /*
   / Get combination of the race code and decode for each subject
   /--------------------------------------------------------------------------*/   
   data  &l_prefix.mod2;
      ...
      do;    
         ...
         /* if current and previous race code are sub-races, set the race code to mixed race */
         else if ( &raceccdvar in ('03' '04' '05' '06')) and ( &l_varprefix.cdvar in ('03' '04' '05' '06' '07')) then 
         do;
            &l_varprefix.cdvar='07';
         end;    
         else if ( &raceccdvar in ('09' '10')) and ( &l_varprefix.cdvar in ('09' '10' '11')) then 
         do;
            &l_varprefix.cdvar='11';
         end;                                
         /* if curent code is sub-race, set to mixed race */        
         else do;
            &l_varprefix.cdvar='12';
         end;               
      end;      
