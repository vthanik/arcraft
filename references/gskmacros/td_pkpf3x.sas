...
|                  Linear and Semi-Logarithmic Axes [Cross Over Study]
|
...
| xvar             Passed as %tu_pkcfig parameter of the same name   &g_ptrtgrp=&g_ptrtcd
...
|
****************************************************************************** */
%macro td_pkpf3x(bars=none  /* Bars to be applied to graph */
                ...
                ,xvar=&g_ptrtgrp=&g_ptrtcd  /* X-Axis and Units */
