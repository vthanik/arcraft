...
| Reason for modification:  -changed default value of DSETIN, STACKVAR2 and ORDERVARS
|-----------------------------------------------------------------------------------------
...
/* List of default column widths */
   ...
   STACKVAR2           =%str(varsin=cmatc1 cmcomp cmterm cmreas,varout=ST_CM_ADTR3,sepc=/), /* Create stacked variables */                                  
