...
| -----------------------------------------------------------------------------------
| DSETIN              Specifies the RUCAM-format SI dataset which  dmdata.rucam
|                     needs to be transformed into a RUCAM-format
|                     A&R dataset.
|                     Valid values: valid dataset name
|
| DSETOUT             Specifies the name of the output dataset to  ardata.rucam
|                     be created.
|                     Valid values: valid dataset name
|
...
|                     Valid values: Y, N
|
| DECODERENAME        DECODERENAME      By default, a coded        RUORRS=RUORRES
|                     variable named  ZZZcd will produce a         EVLINT=EVALINT
...
|                     VISITNUM based on the liver event start 
|                     date?
|                     Valid values: Y, N
|
| REFDAT              Specify a reference date variable name to    rudt
...
|   Name         Req/Opt  Description
|   ------------ -------  ----------------------------------------------------
|   &DSETOUT     Req      Parameter specified IDSL standard RUCAM A&R dataset
|----------------------------------------------------------------------------------
...
%macro tc_rucam (
   DSETIN              = dmdata.rucam,     /* Input dataset name */
   DSETOUT             = ardata.rucam,     /* Output dataset name */
   ...
   DECODERENAME        =RUORRS=RUORRES EVLINT=EVALINT, /* List of renames for decoded variables */
   ...
   RECALCVISITYN       =N,                 /* Recalculate VISIT based on the liver event start date */
   REFDAT              =rudt,              /* Reference date variable name for recalculating visit */
   ...
   %let prefix = _tc_rucam;   /* Root name for temporary work datasets */
