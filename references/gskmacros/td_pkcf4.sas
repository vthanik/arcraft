...
| Date:            28-Nov-2009
|
| Macro Purpose:   To create standard: Mean +SD [Analyte] [Matrix] Concentration-Time Plots 
|                  by Treatment (Linear and Semi-log)
|
...
| bars             Passed as %tu_pktfig parameter of the same name   SD
...
%macro td_pkcf4(
  ...
  ,bars = SD                                    /* Bars to be applied to graph            */
