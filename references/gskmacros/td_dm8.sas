...
| Date:             10DEC2004
|
| Macro Purpose:    A macro to create IDSL standard display DM8
|
...
|                     summarised.
|
| PSFORMAT            Passed to the PROC SUMMARY FORMAT statement. The  raceccd $raceasl.
...
%macro td_dm8(
   ...
   DDDATASETLABEL      =DD dataset for table DM8, /* Label to be applied to the DD dataset */
   ...
   PSFORMAT            =raceccd $raceasl., /* Passed to the PROC SUMMARY FORMAT statement. */
