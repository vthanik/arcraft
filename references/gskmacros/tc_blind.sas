...
| Date:            26-Jun-2004
|
| Macro Purpose:   Blind wrapper macro
|
...
| -----------------  -------------------------------------  -------  ----------
| DSETIN             Specifies the BLIND-format SI dataset  REQ      dmdata.blind
...
|                    Valid values: Y, N
|
| REFDAT             Specify a reference date variable name OPT      BLDT
|                    to pass to %tu_recalcvisit to  
|                    calculate the visit. Will be checked  
|                    in %tu_recalcvisit
|
| REFTIM             Specify a reference time variable name OPT      BLTM
|                    to pass to %tu_recalcvisit to  
|                    calculate the visit. Will be checked  
|                    in %tu_recalcvisit
|
...
| Date of Modification:     28-Mar-2005
| New version/draft number: 1/2
| Modification ID:          YW001
| Reason For Modification:  Modified one error message, which appears as -
|                           RECALCVISITYN should be either Y or N.
|
*******************************************************************************
| Modified By:              Yongwei Wang
...
| Reason For Modification:  Missing parameters were added to tu_derive. (HRT0228)
|
|*******************************************************************************
...
*******************************************************************************/
%macro tc_blind (
     dsetin            = DMDATA.BLIND,  /* Input dataset name */
     ...
     reftim            = bltm,    /* Reference data variable name for recalculating visit and calculating treatment period */
 ...
 %local prefix;
 %let prefix = _tc_blind;   /* Root name for temporary work datasets */
 ...
 /*
 / Only keep records where blind was broken.
 /----------------------------------------------------------------------------*/
 ...
 %do;
    %tu_derive (
         ...
         refdateoption     = &dyrefdateoption,       /* BA001 */  
         refdatevisitnum   = &dyrefdatevisitnum,     /* BA001 */  
         refdatesourcedset = &dyrefdatesourcedset,   /* BA001 */  
         refdatesourcevar  = &dyrefdatesourcevar,    /* BA001 */  
         refdatedsetsubset = &dyrefdatedsetsubset,   /* BA001 */  
