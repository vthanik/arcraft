...
*  Date:           04sep2003
*
*  Macro purpose:  display macro to generate IDSL ae9 listing
*
...
*                  provided here.                                     %str( varsin=&g_centid &g_subjid &g_trtcd, varout=st_ae_cst9, sepc=/  ) 
*  stackvar2       Additional stacked variables (ref: stackvar1)      %str( varsin=&g_ptrtgrp period ,varout=st_ae_pp9, sepc=/ ) 
*  stackvar3       Additional stacked variables (ref: stackvar1)      %str( varsin=age sex race ,varout=st_ae_asr9, sepc=/ )  
*  stackvar4       Additional stacked variables (ref: stackvar1)      %str( varsin=aept aeterm, varout=st_ae_pt9, sepc=/ )
*  stackvar5       Additional stacked variables (ref: stackvar1)      %str( varsin=aeout aestdt aeendt aedurc, varout=st_ae_osed9, sepc=/ ) 
*  stackvar6       Additional stacked variables (ref: stackvar1)      %str( varsin=aesev aeser aewd, varout=st_ae_ssw9, sepc=/, formats=aeser $yesno. aewd $yesno. )
*  stackvar7       Additional stacked variables (ref: stackvar1)      %str( varsin=aeacttrt aerel, varout=st_ae_ar9, sepc=/, formats=aerel $yesno. )
*  stackvar8       Additional stacked variables (ref: stackvar1) 
*  - stackvar15                                                       blank
...
*                  string                                              DD datset for AE9 listing
...
*                  COLUMN statement syntax                             st_ae_cst9 pernum st_ae_pp9 st_ae_asr9 aestdt st_ae_pt9 st_ae_osed9
*                                                                      st_ae_ssw9 st_ae_ar9
...
*                  that are also defined with COLUMNS                  st_ae_cst9 pernum st_ae_pp9 st_ae_asr9 aestdt st_ae_pt9
...
*                  rows in the display.                                pernum aestdt
...
*                  width, width of column header)                     st_ae_cst9 6 st_ae_pp9 10 st_ae_asr9 7 st_ae_pt9 24 st_ae_osed9 12 st_ae_ssw9 10 st_ae_ar9 15  
...
%macro td_ae9(
   ...
   stackvar1      =%str( varsin=&g_centid &g_subjid &g_trtcd, varout=st_ae_cst9, sepc=/  ), /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))        */
   stackvar2      =%str( varsin=&g_ptrtgrp period ,varout=st_ae_pp9, sepc=/  ), /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))    */
   stackvar3      =%str( varsin=age sex race ,varout=st_ae_asr9, sepc=/  ),         /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))    */
   stackvar4      =%str( varsin=aept aeterm, varout=st_ae_pt9, sepc=/  ), /*  Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))     */ 
   stackvar5      =%str( varsin=aeout aestdt aeendt aedurc, varout=st_ae_osed9, sepc=/  ), /*  Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))     */
   stackvar6      =%str( varsin=aesev aeser aewd, varout=st_ae_ssw9, sepc=/, formats=aeser $yesno. aewd $yesno.  ), /*  Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))     */
   stackvar7      =%str( varsin=aeacttrt aerel, varout=st_ae_ar9, sepc=/, formats=aerel $yesno.  ),  /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))       */
   ...
   dddatasetlabel =DD datset for AE9 listing, /* Label to be applied to the DD dataset */
   ...
   columns        =st_ae_cst9 pernum st_ae_pp9 st_ae_asr9 aestdt st_ae_pt9 st_ae_osed9 st_ae_ssw9 st_ae_ar9, /* Columns to be included in the listing (plus spanned headers) */
   ordervars      =st_ae_cst9 pernum st_ae_pp9 st_ae_asr9 aestdt st_ae_pt9, /* Order variables               */
   ...
   noprintvars    =pernum aestdt, /* No print variables, used to order the display */
   byvars         =,          /* By variables */
   flowvars       =_all_,     /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =st_ae_cst9 6 st_ae_pp9 10 st_ae_asr9 7 st_ae_pt9 24 st_ae_osed9 12 st_ae_ssw9 10 st_ae_ar9 15, /* List of default column widths */
   skipvars       =st_ae_pt9, /* Variables whose change in value causes the display to skip a line  */
