...
*  Date:           10sep2003
*
*  Macro purpose:  display macro to generate IDSL eg4 listing
*
...
*                  provided here.                                      %str( varsin=&g_centid &g_subjid,varout=st_eg_cs4, sepc=/) 
*  stackvar2       Additional stacked variables (ref: stackvar1)       %str( varsin=age sex race ,varout=st_eg_asr4, sepc=/)                                
*  stackvar3       Additional stacked variables (ref: stackvar1)       %str( varsin=&g_ptrtgrp period ,varout=st_eg_pp4, sepc=/)                                
*  stackvar4       Additional stacked variables (ref: stackvar1)       %str( varsin=visit egdt, varout=st_eg_vd4, sepc=/)  
*  stackvar5       Additional stacked variables (ref: stackvar1)       %str( varsin=egactdy egperdy, varout=st_eg_ap4)                                
...
*                  string                                              DD dataset for EG4 listing
...
*                  COLUMN statement syntax                             &g_centid &g_subjid st_eg_cs4 st_eg_asr4 pernum st_eg_pp4 visitnum egdt st_eg_vd4 st_eg_ap4 eghr pr qrs qt qtcb qtcf 
...
*                  that are also defined with COLUMNS                  &g_centid &g_subjid st_eg_cs4 st_eg_asr4 pernum st_eg_pp4 visitnum egdt   
...
*                  rows in the display.                                &g_centid &g_subjid pernum visitnum egdt 
...
*                  width of  column header)                            st_eg_cs4 st_eg_asr4 st_eg_pp4 st_eg_vd4 st_eg_ap4
...
*                  width, width of column header)                      st_eg_cs4 7 st_eg_asr4 10 st_eg_pp4 12 st_eg_vd4 10 st_eg_ap4 6 eghr 6 pr 6 qrs 5 qt 6 qtcb 5 qtcf 7
...
%macro td_eg4(
   ...
   stackvar1      =%str( varsin=&g_centid &g_subjid,varout=st_eg_cs4, sepc=/) , /*  Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))      */
   stackvar2      =%str( varsin=age sex race ,varout=st_eg_asr4, sepc=/), /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))       */
   stackvar3      =%str( varsin=&g_ptrtgrp period ,varout=st_eg_pp4, sepc=/), /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))       */
   stackvar4      =%str( varsin=visit egdt, varout=st_eg_vd4, sepc=/), /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))       */
   stackvar5      =%str( varsin=egactdy egperdy, varout=st_eg_ap4), /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))       */
   ...
   dddatasetlabel =DD dataset for EG4 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_centid &g_subjid st_eg_cs4 st_eg_asr4 pernum st_eg_pp4 visitnum egdt st_eg_vd4 st_eg_ap4 eghr pr qrs qt qtcb qtcf , /* Columns to be included in the listing (plus spanned headers)  */
   ordervars      =&g_centid &g_subjid st_eg_cs4 st_eg_asr4 pernum st_eg_pp4 visitnum egdt, /*  Order variables  */
   ...
   noprintvars    =&g_centid &g_subjid pernum visitnum egdt, /* No print variables, used to order the display */
   byvars         =,          /* By variables */
   flowvars       =st_eg_cs4 st_eg_asr4 st_eg_pp4 st_eg_vd4 st_eg_ap4, /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =st_eg_cs4 7 st_eg_asr4 10 st_eg_pp4 12 st_eg_vd4 10 st_eg_ap4 6 eghr 6 pr 6 qrs 5 qt 6 qtcb 5 qtcf 7, /* List of default column widths */
