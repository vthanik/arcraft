...
|                    Table (PKPT1X) as defined in the ISDL Standard Data Displays document.
...
|
| CENTREVARS               Passed as %tu_sumstatsinrows parameter of the same name.  clm (Req) 
|
...
|
| COLUMNS                  Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_ptrtcd &g_ptrtgrp tt_bnnm 
|                                                                                    n mean clm std median min max (Req)
|
...
|
| DDDATASETLABEL           Passed as %tu_sumstatsinrows parameter of the same name.  DD Dataset for Table PKPT1X (Req)
|
| DEFAULTWIDTHS            Passed as %tu_sumstatsinrows parameter of the same name.  pppar 10 &g_ptrtgrp 9 tt_bnnm 2 n 2 
|                                                                                    clm 19    (Req)
|
...
|
| LABELS                   Passed as %tu_sumstatsinrows parameter of the same name.  pppar='Param.' &g_ptrtgrp="Trt." 
|                                                                                    %nrstr(clm='95% CI~(Lower,Upper)' )
|                                                                                    (Req)
|
...
|
| NOWIDOWVAR               Passed as %tu_sumstatsinrows parameter of the same name.  &g_ptrtcd (Opt)  
|
...
|    
| STATSDPS                 Passed as %tu_sumstatsinrows parameter of the same name.  std +2 mean +1 median +1 
|                                                                                    clm +1  (Req)
|
| STATSLIST                Passed as %tu_sumstatsinrows parameter of the same name.  n mean clm std median
|                                                                                     min max  (Req) 
|
...
| Reason For Modification :  DIS.01.002.a: Add calls to tu_getdata and tu_nobs
|                                          to allow subsetting
|                                          
...
| Reason For Modification :  GTW.01.003.a: Remove visit columns from defaults       
|
| Modified By :
...
%MACRO td_pkpt1x(
   ...
   BYVARS                   =,                     /* By variables */            
   CENTREVARS               =clm,                  /* Centre justify variables */            
   CODEDECODEVARPAIRS       =&g_ptrtcd &g_ptrtgrp, /* Code and Decode variables in pairs*/
   COLSPACING               =1,                    /* Overall spacing value. */          
   COLUMNS                  =pppar &g_ptrtcd &g_ptrtgrp tt_bnnm n mean clm std median min max, /* Column parameter */
   ...
   DDDATASETLABEL           =DD Dataset for PKPT1X,/* The variables whose values define the subgroup combinations for the analysis */ 
   DEFAULTWIDTHS            =pppar 10 &g_ptrtgrp 9 tt_bnnm 2 n 2 clm 19, /* List of default column widths */
   ...
   IDVARS                   =,                     /* ID variables */
   LABELS                   =pppar='Param.' &g_ptrtgrp="Trt." %nrstr(clm='95% CI~(Lower,Upper)' ),  /* Label definitions. */
   ...
   STATSDPS                 =std +2 mean +1 median +1 clm +1, /* Number of decimal places of summary statistical results*/ 
   STATSLIST                =n mean clm std median min max,   /* List of required summary statistics, e.g. N Mean Median. */
   ...
   /*
   / Echo macro parameters to log file and set prefix for
   / temporary files        
   /-----------------------------------------------------------------------------*/
   ...
   /*
   / Call tu_getdata to subset the CURRENTDATASET  - DIS.01.002.a
