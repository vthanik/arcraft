...
*  Date:           18sep2003
*
*  Macro purpose:  display macro to generate IDSL ex4 listing
*
...
*------------------------------------------------------------------------------------
*  dsetin          The investigational product exposure
*                  data set to act as the subject of the 
*                  report. Valid values: name of a data set
*                  meeting the IDSL dataset specification for 
*                  investigational product exposure data               ardata.exposure
...
*                  string                                              DD dataset for EX4 listing
...
*                  COLUMN statement syntax                             &g_centid &g_subjid &g_ptrtcd &g_ptrtgrp exstdt exendt exdur   
...
*                  that are also defined with COLUMNS                  &g_centid &g_subjid &g_ptrtcd &g_ptrtgrp exstdt    
...
*                  width of  column header)                            &g_ptrtgrp exstdt exendt
...
*                  width, width of column header)                      &g_ptrtgrp 12 &g_centid 6 &g_subjid 6 exstdt 9 exendt 10 exdur 9
...
*                  Valid values: one or more variable names from
*                  DSETIN that are also defined with COLUMNS           exstdt exendt
...
* Date of modification:     04-Jun-2004
* New version number:       1/2
* Modification ID:          YW001
* Reason for modification:  Added OVERALLSUMMARY to the call of tu_list
*
************************************************************************************
* Change Log
*
...
%macro td_ex4(
   dsetin         =ardata.exposure, /* Input investigational product exposure dataset */
   ...
   dddatasetlabel =DD dataset for EX4 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_centid &g_subjid &g_ptrtcd &g_ptrtgrp exstdt exendt exdur, /* Columns to be included in the listing (plus spanned headers)  */
   ordervars      =&g_centid &g_subjid &g_ptrtcd &g_ptrtgrp exstdt, /* Order variables  */
   ...
   noprintvars    =&g_ptrtcd, /* No print variables, used to order the display */
   byvars         =,          /* By variables */
   flowvars       =&g_ptrtgrp exstdt exendt, /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =&g_ptrtgrp 12 &g_centid 6 &g_subjid 6 exstdt 9 exendt 10 exdur 9, /* List of default column widths */
   skipvars       =&g_ptrtgrp, /*  Variables whose change in value causes the display to skip a line */
   ...
   leftvars       =exstdt exendt, /* Left justify variables   */ 
