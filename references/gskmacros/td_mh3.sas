...
*
*
*  Macro purpose:  display macro to generate IDSL mh3 listing
*
...
*                  string                                              DD dataset for MH3 listing
...
*                  COLUMN statement syntax                             &g_centid &g_subjid &g_trtgrp mhbodsys mhterm  
...
*                  that are also defined with COLUMNS                  &g_centid &g_subjid &g_trtgrp mhbodsys  
...
*                  width of  column header)                            &g_trtgrp mhbodsys mhterm
...
*                  width, width of column header)                      &g_centid 6 &g_subjid 6 &g_trtgrp 12  mhbodsys 25 mhterm 32
...
* Date of modification:    16-Jun-2004
* New version number:      1/2
* Modification ID:         YW001
* Reason for modification: Added ',' to the end of the value of parameter LABELVARSYN
*                          in the call of %tu_list.
*
************************************************************************************
* Change Log
*
...
%macro td_mh3(
   dsetin         =ardata.medhist, /* Input medical history dataset */
   ...
   dddatasetlabel =DD dataset for MH3 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_centid &g_subjid &g_trtgrp mhbodsys mhterm, /* Columns to be included in the listing (plus spanned headers)  */
   ordervars      =&g_centid &g_subjid &g_trtgrp mhbodsys, /*  Order variables  */
   ...
   byvars         =,          /* By variables */
   flowvars       =&g_trtgrp mhbodsys mhterm,  /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =&g_centid 6 &g_subjid 6 &g_trtgrp 12  mhbodsys 25 mhterm 32, /* List of default column widths */
