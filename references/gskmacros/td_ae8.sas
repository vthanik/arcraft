...
*
*
*  Macro purpose: display macro to generate IDSL ae8 listing
*
...
*                  provided here.                                     %str( varsin=&g_centid &g_subjid, varout=st_ae_cs8, sepc=/  )
*  stackvar2       Additional stacked variables (ref: stackvar1)      %str( varsin=age sex race ,varout=st_ae_asr8, sepc=/ ) 
*  stackvar3       Additional stacked variables (ref: stackvar1)      %str( varsin=aept aeterm, varout=st_ae_pt8, sepc=/ )  
*  stackvar4       Additional stacked variables (ref: stackvar1)      %str( varsin=aeout aestdt aeendt aedurc, varout=st_ae_osed8, sepc=/ )
*  stackvar5       Additional stacked variables (ref: stackvar1)      %str( varsin=aesev aeser aewd, varout=st_ae_ssw8, sepc=/, formats=aeser $yesno. aewd $yesno. ) 
*  stackvar6       Additional stacked variables (ref: stackvar1)      %str( varsin=aeacttrt aerel, varout=st_ae_ar8, sepc=/, formats=aerel $yesno. )
*  stackvar7       Additional stacked variables (ref: stackvar1) 
*  - stackvar15                                                       blank
...
*                  string                                              DD dataset for AE8 listing
...
*                  COLUMN statement syntax                             &g_trtcd st_ae_cs8 st_ae_asr8 aestdt st_ae_pt8 
*                                                                      st_ae_osed8 st_ae_ssw8  st_ae_ar8
...
*                  that are also defined with COLUMNS                  &g_trtcd st_ae_cs8 st_ae_asr8 aestdt st_ae_pt8
...
*                  rows in the display.                                 &g_trtcd aestdt
...
*                  width, width of column header)                      st_ae_cs8 7 st_ae_asr8 10 st_ae_pt8 20 st_ae_osed8 19 
*                                                                      st_ae_ssw8 10 st_ae_ar8 15 
...
%macro td_ae8(
         ...
         stackvar1=%str( varsin=&g_centid &g_subjid, varout=st_ae_cs8, sepc=/  ) , /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))        */
         stackvar2=%str( varsin=age sex race ,varout=st_ae_asr8, sepc=/ ) ,        /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))    */
         stackvar3=%str( varsin=aept aeterm, varout=st_ae_pt8, sepc=/ )  ,         /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))    */
         stackvar4=%str( varsin=aeout aestdt aeendt aedurc, varout=st_ae_osed8, sepc=/), /*  Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))     */ 
         stackvar5=%str( varsin=aesev aeser aewd, varout=st_ae_ssw8, sepc=/, formats=aeser $yesno. aewd $yesno. ) , /*  Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))     */
         stackvar6=%str( varsin=aeacttrt aerel, varout=st_ae_ar8, sepc=/, formats=aerel $yesno. ), /*  Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))     */
         ...
         dddatasetlabel=DD dataset for AE8 listing, /* Label to be applied to the DD dataset */
         ...
         columns=&g_trtcd st_ae_cs8 st_ae_asr8 aestdt st_ae_pt8 st_ae_osed8 st_ae_ssw8 st_ae_ar8, /* Columns to be included in the listing (plus spanned headers) */
         ordervars      =&g_trtcd st_ae_cs8 st_ae_asr8 aestdt st_ae_pt8, /* Order variables               */
         ...
         noprintvars    =&g_trtcd aestdt, /* No print variables, used to order the display */
         byvars         =,          /* By variables */
         flowvars       =_all_,     /* Variables with flow option */
         widths         =,          /* Column widths */
         defaultwidths=st_ae_cs8 7 st_ae_asr8 10 st_ae_pt8 20 st_ae_osed8 19 st_ae_ssw8 10 st_ae_ar8 15 , /* List of default column widths */
         skipvars       =st_ae_pt8,       /* Variables whose change in value causes the display to skip a line  */
