...
|                     Valid values: name of a data set meeting the      re=(display2 eq   
...
/* Order variables */
   ...
   STACKVAR2           =%str(varsin=cmatc1 cmdecod cmterm,varout=ST_CM_ADT2,sepc=/), /* Create stacked variables (e.g., stackvar2=%str(varsin= invid subjid, varout= st_inv_subj, sepc=/, splitc=~) ) */                                              
