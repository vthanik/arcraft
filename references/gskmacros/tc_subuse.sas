...
| Date:            29-Jun-2004
|
| Macro Purpose:   Subuse wrapper macro
|
...
| -----------------  -------------------------------------  -------  ----------
| DSETIN             Specifies the SUBUSE-format SI         REQ      DMDATA.SUBUSE
|                    dataset which needs to be transformed 
|                    into a SUBUSE-format A&R dataset.
|                    Valid values: valid dataset name
|
| DSETOUT            Specifies the name of the output       REQ      ARDATA.SUBUSE
...
|                    derivations for this domain code (SU)?
|                    Valid values: Y, N
|
...
|
| REFDAT             Specify a reference date variable name OPT      SUDT
|                    to pass to %tu_calctpernum to  
|                    calculate treatment period. Will be   
|                    checked in %tu_calctpernum 
|
| REFTIM             Specify a reference time variable name OPT      (Blank) 
|                    to pass to %tu_calctpernum to  
|                    calculate treatment period. Will be   
|                    checked in %tu_calctpernum
|
...
| Reason For Modification:  1. Added new parameter XOVARSFORPGYN, REFDAT and
|                              REFTIM. They will be validated and passed to 
|                              %tu_derive
...
*******************************************************************************/
%macro tc_subuse (
     dsetin            = DMDATA.SUBUSE,  /* Input dataset name */
     dsetout           = ARDATA.SUBUSE,  /* Output dataset name */     
     ...
     refdat            = sudt,       /* Reference data variable name for calculating treatment period */
     reftim            = ,           /* Reference time variable name for calculating treatment period */
 ...
 %local prefix;
 %let prefix = _tc_subuse;   /* Root name for temporary work datasets */
