...
*
*
*  Macro purpose:  display macro to generate IDSL sd2 listing
*
...
*                  dataset                                            %str(upcase(substr(sdstop, 1, 1))='Y')
...
*                  string                                              DD dataset for SD2 listing
...
*                  COLUMN statement syntax                             &g_trtcd &g_trtgrp &g_centid &g_subjid sdendt sdactdy sdreason
...
*                  width of  column header)                            &g_trtgrp sdreason
...
*                  width, width of column header)                      &g_trtgrp 14 &g_centid 6 &g_subjid 8 sdendt 10 sdactdy 8 sdreason 34
...
* Date of modification:   08 June 2004
* New version number:     1/2
* Modification ID:
* Reason for modification: Add a line in the macro header to indicate that
*                          tu_abort is one of the macros called.
*
* Modified by:
...
%macro td_sd2(
   ...
   dddatasetlabel=DD dataset for SD2 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_trtcd &g_trtgrp &g_centid &g_subjid sdendt sdactdy sdreason  , /* Columns to be included in the listing (plus spanned headers)  */
   ...
   byvars         =,          /* By variables */
   flowvars       =&g_trtgrp sdreason , /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =&g_trtgrp 14 &g_centid 6 &g_subjid 8 sdendt 10 sdactdy 8 sdreason 34, /* List of default column widths */
 ...
 proc sql;
    create table &L_PREFIX.sd21 as select *,
      case (upcase(sdreascd))
           when 'Z' then 'Other: ' !! sdrsoth
           else sdreas
           end
           as sdreason label='Reason for Withdrawal'
      from &l_workdata;
 quit;

  %let l_workdata=&l_prefix.sd21;
