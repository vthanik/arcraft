...
| ----------------------------------------------------------------------------------------
| ACROSSVAR           Variable to transpose the data across to make     aesevcd  
...
|                     DSETINNUMER                                                         
|                                                                                         
| ACROSSVARDECODE     A variable or format used in the construction of  aesev
...
|                     Valid Values: one or more variable names plus     tt_pct9 aept    
...
|                     GROUPBYVARSANALY                                                    
|                                                                                         
| COMPUTEBEFOREPAGEL  See Unit Specification for HARP Reporting Tools   TRTMNT          
| INES                TU_LIST[5] for complete details                   $local. :  
|                                                                       &g_trtgrp        
|                                                                                         
...
|                                                                                         
| DEFAULTWIDTHS       Specifies column widths for all variables not     aesoc 30
|                     listed in the WIDTHS parameter                    aept 30  
...
|                     define statement attribute DESCENDING             tt_pct9
|                     Valid Values: one or more variable names that     
...
|                     this parameter then all displayable order         tt_pct9 aept    
...
|                     are given the PROC REPORT define statement        tt_ac9          
|                     attribute noprint                                 summaryLevel      
|                     Valid Values: one or more variable names that     tt_pct9
|                     are also defined with COLUMNS                       
...
|                     Valid Values: one or more variable names that     tt_pct9 aept    
|                     are also defined with COLUMNS                    
|                                                                      
|                                                                                         
...
|                     are also defined with COLUMNS                                       
|                                                                                         
| POSTSUBSET          SAS expression to be applied to data immediately  if tt_pct9 gt 0 
...
|                     usage, NUMERPCT.                                                    
|                                                                                         
| TOTALFORVAR         Passed to %tu_statswithtotal. Variable for which  aesevcd  
...
|                     character.                                                          
|                                                                                         
| TOTALID             Value used to populate the variable specified in  9      
...
|---------------------------------------------------------------------------------------*/
%macro td_ae5b(
   ACROSSVAR           =aesevcd,           /* Variable to transpose the data across to make columns of results. This is passed to the proc transpose ID statement */                                                                 
   ACROSSVARDECODE     =aesev,             /* A variable or format used in the construction of labels for the result columns. Usually &g_trtgrp */                                                                                    
   ...
   COLUMNS             =tt_spsort aesoc summaryLevel tt_pct9 aept tt_ac:, /* Columns to be included in the listing (plus spanned headers) */                                                              
   ...
   DESCENDING          =tt_spsort tt_pct9, /* Descending ORDERVARS */                                                                                                                                         
   ...
   IDVARS              =tt_spSort aesoc summaryLevel tt_pct9 aept, /* Variables to appear on each page of the report */                                                                                       
   ...
   NOPRINTVARS         =tt_spsort tt_ac9 summaryLevel tt_pct9, /* No print variables, used to order the display */                                                                                          
   ...
   ORDERVARS           =tt_spsort aesoc summaryLevel tt_pct9 aept, /* Order variables */                                                                                                                      
   PAGEVARS            =,                  /* Variables whose change in value causes the display to continue on a new page */                                                                                                                                
   POSTSUBSET          =if tt_pct9 gt 0,   /* SAS expression to be applied to data immediately prior to creation of the permanent presentation dataset */                                                       
   ...
   TOTALFORVAR         =aesevcd,           /* Variable(s) for which a overall total is required */                                                                                                                                   
   TOTALDECODE         =Total,             /* Label for the total result column. Usually the text Total */                                                                                                                                                   
   TOTALID             =9,                 /* Value used to populate the variable specified in ACROSSVAR on data that represents the overall total for the ACROSSVAR variable. */                                                                       
