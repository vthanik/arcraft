...
|                    Table (PKPT3X) as defined in the ISDL Standard Data Displays document.
...
|
| CENTREVARS               Passed as %tu_sumstatsinrows parameter of the same name.  clmlog (Opt) 
|
...
|
| COLUMNS                  Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_ptrtcd &g_ptrtgrp tt_bnnm n
|                                                                                    geomean clmlog stdlog cvblog (Req) 
|
| COMPLETETYPESVARS        Passed as %tu_sumstatsinrows parameter of the same name.  &g_ptrtcd &g_ptrtgrp (Req)
|
...
|
| DDDATASETLABEL           Passed as %tu_sumstatsinrows parameter of the same name.  DD Dataset for PKPT3X (Req)
|
| DEFAULTWIDTHS            Passed as %tu_sumstatsinrows parameter of the same name.  pppar 10 &g_ptrtgrp 9 tt_bnnm 2 n 2 clmlog 17 stdlog 15
|
...
|
| FLOWVARS                 Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_ptrtgrp (Req)
| 
...
|
| LABELS                   Passed as %tu_sumstatsinrows parameter of the same name.  pppar="Param." geomean="Geom. Mean" 
|                                                                                     %nrstr(clmlog="95% CI~(Lower,Upper)"
|                                                                                     cvblog="%CVb" stdlog="SD Logs" )  (Req))
|
...
|
| NOPRINTVARS              Passed as %tu_sumstatsinrows parameter of the same name.  &g_ptrtcd (Req)
|
| NOWIDOWVAR               Passed as %tu_sumstatsinrows parameter of the same name.  &g_ptrtcd (Req)  
|
...
|
| ORDERVARS                Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_ptrtcd &g_ptrtgrp tt_bnnm (Req) 
|
...
|
| SHARECOLVARSINDENT       Passed as %tu_sumstatsinrows parameter of the same name.  1 (Req)
|
...
|    
| STATSDPS                 Passed as %tu_sumstatsinrows parameter of the same name.  geomean +1 clmlog +1 stdlog +2 (Req)
|
| STATSLIST                Passed as %tu_sumstatsinrows parameter of the same name.  n geomean clmlog stdlog cvblog (Req) 
|
...
| Reason For Modification : DIS.01.002.a: Changes in header due to SCR
...
%MACRO td_pkpt3x(
   ...
   BYVARS                   =,                     /* By variables */
   CENTREVARS               =clmlog,               /* Centre justify variables */
   CODEDECODEVARPAIRS       =&g_ptrtcd &g_ptrtgrp, /* Code and Decode variables in pairs*/
   COLSPACING               =1,                    /* Overall spacing value. */
   COLUMNS                  =pppar &g_ptrtcd &g_ptrtgrp tt_bnnm n geomean clmlog stdlog cvblog,/* Column parameter */
   ...
   DDDATASETLABEL           =DD dataset for PKPT3X,/* Label to be applied to the DD dataset */
   DEFAULTWIDTHS            =pppar 10 &g_ptrtgrp 9 tt_bnnm 2 n 2 clmlog 17 stdlog 15, /* List of default column widths */
   DESCENDING               =,                     /* Descending ORDERVARS */
   DISPLAY                  =Y,                    /* Specifies whether the report should be created */
   DSETIN                   =ardata.pkpar,         /* Input analysis dataset*/
   DSETOUT                  =,                     /* Output summary dataset*/
   FLOWVARS                 =pppar &g_ptrtgrp,     /* Variables with flow option */
   ...
   IDVARS                   =,                     /* ID variables */
   LABELS                   =pppar="Param." geomean="Geom. Mean"  %nrstr(clmlog="95% CI~(Lower,Upper)" stdlog="SD Logs" cvblog="%CVb"), /* Label definitions. */
   ...
   NOPRINTVARS              =&g_ptrtcd,            /* No print vars (usually used to order the display) */
   NOWIDOWVAR               =&g_ptrtcd,            /* Not in version 1 */
   ORDERDATA                =,                     /* ORDER=DATA variables */
   ORDERFORMATTED           =,                     /* ORDER=FORMATTED variables */
   ORDERFREQ                =,                     /* ORDER=FREQ variables */
   ORDERVARS                =pppar &g_ptrtcd &g_ptrtgrp tt_bnnm, /* Order variables */
   ...
   SHARECOLVARSINDENT       =1,                    /* Indentation factor */
   ...
   STATSDPS                 =geomean +1 clmlog +1 stdlog +2,  /* Number of decimal places of summary statistical results*/
   STATSLIST                =n geomean clmlog stdlog cvblog,  /* List of required summary statistics, e.g. N Mean Median. */
