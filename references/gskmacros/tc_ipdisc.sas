...
| -----------------------------------------------------------------------------------
| DSETIN              Specifies the LAB-format SI dataset which    dmdata.ipdisc
|                     needs to be transformed into a LAB-format
|                     A&R dataset.
|                     Valid values: valid dataset name
|
| DSETOUT             Specifies the name of the output dataset to  ardata.ipdisc
|                     be created.
|                     Valid values: valid dataset name
|
...
|                     Valid values: Y, N.
|
| REFDAT              Specify a reference date variable name to    actdt
...
%macro tc_ipdisc (
   DSETIN              =dmdata.ipdisc,     /* Input dataset name */
   ...
   %let prefix = _tc_ipdisc;   /* Root name for temporary work datasets */
