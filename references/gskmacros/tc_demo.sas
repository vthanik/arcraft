...
| Date:            27-Jun-2004
|
| Macro Purpose:   Demo wrapper macro
|
...
| -----------------  -------------------------------------  -------  ----------
| DSETIN             Specifies the DEMO-format SI dataset   REQ      DMDATA.DEMO
|                    which needs to be transformed into a 
|                    DEMO-format A&R dataset.
|                    Valid values: valid dataset name 
|
| DSETOUT            Specifies the name of the output       REQ      ARDATA.DEMO
...
*******************************************************************************/
%macro tc_demo (
     dsetin            = DMDATA.DEMO,  /* Input dataset name */
 ...
 %local prefix;
 %let prefix = _tc_demo;   /* Root name for temporary work datasets */
