...
*  Date:           16sep2003
*
*  Macro purpose:  display macro to generate IDSL eg5 listing
*
...
*                  provided here.                                      %str( varsin=age sex race ,varout=st_eg_asr5, sepc=/   ) 
*  stackvar2       Additional stacked variables (ref: stackvar1)       %str(varsin=visit egdt, varout=st_eg_vd5, sepc=/)
*  stackvar3       
*  - stackvar15                                                        blank
...
*                  string                                              DD dataset for EG5 listing
...
*                  COLUMN statement syntax                             &g_trtcd &g_trtgrp &g_centid &g_subjid st_eg_asr5 visitnum egdt st_eg_vd5 egactdy egintp egchbl egfind 
...
*                  that are also defined with COLUMNS                  &g_trtcd &g_centid &g_subjid st_eg_asr5 visitnum egdt st_eg_vd5 egactdy  
...
*                  rows in the display.                                &g_trtgrp &g_trtcd visitnum egdt  
...
*                  width of  column header)                            st_eg_asr5 st_eg_vd5 egintp egchbl egfind
...
*                  width, width of column header)                      &g_trtgrp 90 &g_centid 6 &g_subjid 6 st_eg_asr5 8 st_eg_vd5 10 egactdy 5 egintp 15 egchbl 11 egfind 19
...
* Date of modification:     07-Jun-2004
* New version number:       1/2
* Modification ID:          YW001
* Reason for modification:  Added the code to combine EGOTH to EGFIND when EGFINDCD
*                           equals E99
************************************************************************************
* Change Log
*
...
%macro td_eg5(
   ...
   stackvar1      =%str(varsin=age sex race, varout=st_eg_asr5, sepc=/), /*  Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))      */
   stackvar2      =%str(varsin=visit egdt, varout=st_eg_vd5, sepc=/), /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))       */
   ...
   dddatasetlabel=DD dataset for EG5 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_trtcd &g_trtgrp &g_centid &g_subjid st_eg_asr5 visitnum egdt st_eg_vd5 egactdy egintp egchbl egfind, /* Columns to be included in the listing (plus spanned headers)  */
   ordervars      =&g_trtcd &g_centid &g_subjid st_eg_asr5 visitnum egdt st_eg_vd5 egactdy, /*  Order variables  */
   ...
   noprintvars    =&g_trtcd &g_trtgrp visitnum egdt, /* No print variables, used to order the display */
   byvars         =,          /* By variables */
   flowvars       =st_eg_asr5 st_eg_vd5 egintp egchbl egfind, /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =&g_trtgrp 90 &g_centid 6 &g_subjid 6 st_eg_asr5 8 st_eg_vd5 10 egactdy 5 egintp 15 egchbl 11 egfind 19, /* List of default column widths */
   ...
   /*                                                                       
   /  Call tu_tideup to clear temporary data set and fields.           
   /--------------------------------------------------------------------*/
