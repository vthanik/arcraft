...
| Date:            28-Nov-2009
|
| Macro Purpose:   To create non-standard: [Analyte] [Matrix] Concentration-Time Plots
|
...
| ylogbase         Passed as %tu_pktfig parameter of the same name   10
| ylogstyle        Passed as %tu_pktfig parameter of the same name   EXPAND
...
| bystyle          Passed as %tu_pktfig parameter of the same name   label-equals-comma
| zvar             Passed as %tu_pktfig parameter of the same name   [blank]
...
| formats          Passed as %tu_pktfig parameter of the same name   
|
...
| gptsize          Passed as %tu_pktfig parameter of the same name   [blank]
|
...
| symbolOther      Passed as %tu_pktfig parameter of the same name   [blank]
| symbolOtherDelim Passed as %tu_pktfig parameter of the same name   /       
| varlabelstyle    Passed as %tu_pktfig parameter of the same name   STD
|
...
%macro td_pkcf7(
  ...
  ,ylogstyle = EXPAND                           /* Y-axis log scale style                 */
  ...
  ,zvar =                                       /* 3rd Classification var (i.e. line)     */
  ...
  ,formats =                                    /* Formats to be applied to plot axes     */
  ...
  ,gptsize =                                    /* Pt. size for graph text (blank=ptsize) */
  ...
  ,symbolOther =                                /* Other elements for symbol stmts        */
  ,symbolOtherDelim = /                         /* Delimiter for SYMBOLOTHER              */
  ,varlabelstyle = STD                          /* Label style (tu_labelvars)             */
  );
