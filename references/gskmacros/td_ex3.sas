...
*  Date:           18sep2003
*
*  Macro purpose:  display macro to generate IDSL ex3 listing
*
...
*                  string                                              DD dataset for EX3 listing
...
*                  COLUMN statement syntax                             &g_trtcd &g_trtgrp &g_centid &g_subjid exstdt exendt exdur
...
*                  that are also defined with COLUMNS                  &g_trtcd &g_trtgrp &g_centid &g_subjid exstdt
...
*                  width of  column header)                            &g_trtgrp exstdt exendt
...
*                  width, width of column header)                      &g_trtgrp 15 &g_centid 6 &g_subjid 6 exstdt 12 exendt 12 exdur 9
...
%macro td_ex3(
   ...
   dddatasetlabel =DD dataset for EX3 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_trtcd &g_trtgrp &g_centid &g_subjid exstdt exendt exdur, /* Columns to be included in the listing (plus spanned headers)  */
   ordervars      =&g_trtcd &g_trtgrp &g_centid &g_subjid exstdt, /*  Order variables  */
   ...
   byvars         =,          /* By variables */
   flowvars       =&g_trtgrp exstdt exendt, /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =&g_trtgrp 15 &g_centid 6 &g_subjid 6 exstdt 12 exendt 12 exdur 9, /* List of default column widths */
