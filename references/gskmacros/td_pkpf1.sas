...
| Date:            21-Jun-2005
|
| Macro Purpose:   Wrapper to Create Graphs of: Plot for [Matrix] [Analyte] [Parameter]
|                  against Dose on Linear and Logarithmic Axes
|
...
| gmmeanyn         Passed as %tu_pkcfig parameter of the same name   Y
...
| symbolLine       Passed as %tu_pkcfig parameter of the same name   1 4
| symbolMax        Passed as %tu_pkcfig parameter of the same name   24
| symbolOther      Passed as %tu_pkcfig parameter of the same name   width=4/width=1
| symbolOtherDelim Passed as %tu_pkcfig parameter of the same name   /
| symbolValue      Passed as %tu_pkcfig parameter of the same name   [blank]
...
| xlabel           Passed as %tu_pkcfig parameter of the same name   Dose
| xmax             Passed as %tu_pkcfig parameter of the same name   [blank]
| xvar             Passed as %tu_pkcfig parameter of the same name   dose
...
| ylogbase         Passed as %tu_pkcfig parameter of the same name   2
...
|
****************************************************************************** */
%macro td_pkpf1(bars=none  /* Bars to be applied to graph */
               ...
               ,symbolLine=1 4  /* Lines for symbol statements */
               ,symbolMax=24 /* Number of SYMBOL statements */
               ,symbolOther=width=4/width=1  /* Other elements for symbol statements */
               ,symbolOtherDelim=/  /* Delimiter for SYMBOLOTHER */
               ,symbolValue=dot circle  /* Plot symbols for symbol statements */
               ...
               ,xlabel=Dose  /* X-Axis Label */
               ,xmax=  /* Upper limit of X-Axis */
               ,xvar=dose  /* X-Axis and Units */
               ,xvarlogyn=Y  /* if log graph? log x axis Y/N */
               ,xvarorder=  /* X axis order by string */
               ,yint=  /* Y-Order interval */
               ,ylabel=  /* Y-Axis Label */
               ,ylogbase=2  /* Y-Axis Log base */
