...
| Date:               19-May-2005
|                                   
| Macro purpose:      display macro to generate IDSL cm5 listing
|                    
...
|                                                                                         
| COLUMNS             A PROC REPORT column statement specification.     ST_CM_CST5 pernum 
|                     Including spanning titles and variable names      ST_CM_PP5 cmstdt  
|                     Valid values: one or more variable names from     ST_CM_ADTR5       
|                     DSETIN plus other elements of valid PROC REPORT   ST_CM_UUFR5       
|                     COLUMN statement syntax                           ST_CM_SAP5        
|                                                                       ST_CM_EAP5        
|                                                                       cmprior cmongo    
|                                                                                         
...
|                                                                                         
| DEFAULTWIDTHS       This parameter specifies default column widths    ST_CM_CST5 6      
|                     for all variables not listed in the WIDTHS        ST_CM_PP5 8       
|                     parameter.                                        ST_CM_ADTR5 22    
|                     Valid values: values of column names and numeric  ST_CM_UUFR5 6     
|                     widths, a list of variables followed by a         ST_CM_SAP5 10     
|                     positive integer, e.g.                            ST_CM_EAP5 10     
|                                                                       cmprior 7 cmongo 7
...
|                                                                                         
| DSETIN              The concomitant medications data set to act as    ardata.cmanal(wher
|                     the subject of the report.                        e=(display1 eq 1))
...
|                     where format for display differs to the format    cmprior $yesno.
|                     on the DSETIN.                                                      
...
|                     defined as NOPRINT                                                  
|                                                                                         
| NOPRINTVARS         Variables listed in the COLUMN parameter that     pernum cmstdt
...
|                     attribute order=internal                                            
|                                                                                         
| ORDERVARS           List of variables that will receive the PROC      ST_CM_CST5 pernum 
|                     REPORT define statement attribute ORDER           ST_CM_PP5 cmstdt  
|                     Valid values: one or more variable names from     ST_CM_ADTR5 st_cm_uufr5       
|                     DSETIN that are also defined with COLUMNS         st_cm_sap5  st_cm_eap5  
|                                                                       cmprior cmongo 
|                                                                                         
...
|                     Valid values: positive integer                                      
|                                                                                         
| SKIPVARS            Variables whose change in value causes the        ST_CM_ADTR5       
...
|                     the macro call.  Note that the DSETIN parameter   = ST_CM_CST5,     
...
|                                                                       = / )             
|                                                                                         
| STACKVAR5           Additional stacked variables (ref: stackvar1)     %str( varsin =    
|                                                                       cmstd_ cmactsdy   
|                                                                       cmpersdy,         
|                                                                       varout =          
|                                                                       ST_CM_SAP5, sepc  
|                                                                       = / )             
|                                                                                         
| STACKVAR6           Additional stacked variables (ref: stackvar1)     %str( varsin =    
|                                                                       cmend_ cmactedy   
|                                                                       cmperedy,  varout 
|                                                                       = ST_CM_EAP5,     
|                                                                       sepc = / )        
|                                                                                         
| STACKVAR7-          Specifies any variables that should be stacked    No default        
...
%macro td_cm5b(
   ...
   COLUMNS             =ST_CM_CST5 pernum ST_CM_PP5 cmstdt ST_CM_ADTR5 ST_CM_UUFR5 ST_CM_SAP5 ST_CM_EAP5 cmprior cmongo, /* Columns to be included in the listing (plus spanned headers) */                                                                  
   ...
   DDDATASETLABEL      =DD dataset for CM5 listing, /* Label to be applied to the DD dataset */                                                                                                                                                              
   DEFAULTWIDTHS       =ST_CM_CST5 6 ST_CM_PP5 8 ST_CM_ADTR5 22 ST_CM_UUFR5 6 ST_CM_SAP5 10 ST_CM_EAP5 10 cmprior 7 cmongo 7, /* List of default column widths */                                                                                            
...
FORMATS             =cmongo $yesno. cmprior $yesno.,
/* Format specification (valid SAS syntax) */
   ...
   NOPRINTVARS         =pernum cmstdt,     /* No print vars, used to order the display */                                                                                                                                                                    
...
ORDERVARS           =ST_CM_CST5 pernum ST_CM_PP5 cmstdt ST_CM_ADTR5 ST_CM_UUFR5 ST_CM_SAP5 ST_CM_EAP5 cmprior cmongo,
/* Order variables */
   ...
   SKIPVARS            =ST_CM_ADTR5,       /* Variables whose change in value causes the display to skip a line */                                                                                                                                           
   SPLITCHAR           =~,                 /* Split character */                                                                                                                                                                                             
   STACKVAR1           =%str(varsin=&g_centid &g_subjid &g_trtgrp,varout=ST_CM_CST5,sepc=/), /* Create stacked variables */                                   
   STACKVAR2           =%str(varsin=&g_ptrtgrp period,varout=ST_CM_PP5,sepc=/), /* Create stacked variables */                                                
   STACKVAR3           =%str(varsin=cmatc1 cmdecod cmterm cmreas,varout=ST_CM_ADTR5,sepc=/), /* Create stacked variables */                                       
   STACKVAR4           =%str(varsin=cmudos cmunit cmfreq cmroutcd,varout=ST_CM_UUFR5,sepc=/), /* Create stacked variables */                                  
   STACKVAR5           =%str(varsin=cmstd_ cmactsdy cmpersdy,varout=ST_CM_SAP5,sepc=/), /* Create stacked variables */                                      
   STACKVAR6           =%str(varsin=cmend_ cmactedy cmperedy,varout=ST_CM_EAP5,sepc=/), /* Create stacked variables */                                       
