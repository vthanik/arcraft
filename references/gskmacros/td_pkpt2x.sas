...
|                    Table (PKPT2X) as defined in the ISDL Standard Data Displays document.
...
|
| DDDATASETLABEL           Passed as %tu_sumstatsinrows parameter of the same name.  DD Dataset for Table PKPT2X (Req)
|
| DEFAULTWIDTHS            Passed as %tu_sumstatsinrows parameter of the same name.  pppar 12 tt_svnm 10 tt_p: 17
|
...
|                                                                                           geomeanclm="Geom. Mean~  95% CI" ) (Req)
|
| STATSLIST                Passed as %tu_sumstatsinrows parameter of the same name.  n meanclm geomeanclm std median min max
|                                                                                     (Req)
|
...
%MACRO td_pkpt2x(
   ...
   DDDATASETLABEL           =DD dataset for PKPT2X, /* Label to be applied to the DD dataset */
   DEFAULTWIDTHS            =pppar 12 tt_svnm 10 tt_p: 17, /* List of default column widths */
   ...
   NOPRINTVARS              =tt_svid,              /* No print vars (usually used to order the display) */
   ...
   STATSDPS                 =meanclm +1 geomeanclm +1 std +2 median +1, /* Number of decimal places of summary statistical results*/
