...
*
*
*  Macro purpose: display macro to generate IDSL dm4 listing
*
*
...
*                  string                                              DD dataset for DM4 listing
...
*                  COLUMN statement syntax                             &g_centid &g_subjid &g_trtgrp dmdt birthdt age sex ethnic 
...
%macro td_dm4
       (dsetin         =ardata.demo, /* Input demographics dataset */
         ...
         dddatasetlabel =DD dataset for DM4 listing, /* Label to be applied to the DD dataset */
         ...
         columns        =&g_centid &g_subjid &g_trtgrp dmdt birthdt age sex ethnic , /* Columns to be included in the listing (plus spanned headers)  */
