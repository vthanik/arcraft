...
*  Date:          04aug2003
*
*  Macro purpose: display macro to generate IDSL bl1 listing
*
...
*                  string                                              DD dataset for BL1 listing
...
*                  COLUMN statement syntax                             &g_trtcd &g_trtgrp &g_centid &g_subjid bldt blactdy blreason  
...
*                  width of coulmn header).                            &g_trtgrp blreason
...
*                  width, width of column header)                      blreason 30 blactdy 5
...
%macro td_bl1(
    ...
    dddatasetlabel =DD dataset for BL1 listing,  /* Label to be applied to the DD dataset                        */ 
    ...
    columns        =&g_trtcd &g_trtgrp &g_centid &g_subjid bldt blactdy blreason, /* Columns to be included in the listing (plus spanned headers) */
    ...
    byvars         =,          /* By variables */
    flowvars       =&g_trtgrp blreason,     /* Variables with flow option */
    widths         =,          /* Column widths */
    defaultwidths  =blreason 30 blactdy 5, /* List of default column widths */
    skipvars       =&g_trtcd,  /* Variables whose change in value causes the display to skip a line  */
