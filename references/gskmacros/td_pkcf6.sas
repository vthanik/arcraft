...
| Date:            28-Nov-2009
|
| Macro Purpose:   To create standard: Individual [Analyte] [Matrix] Concentration-Time Plots (Linear and Semi-log)
|
...
| style            Passed as %tu_pktfig parameter of the same name   SPAGHETTI
| bars             Passed as %tu_pktfig parameter of the same name   NONE
| postsubset       Passed as %tu_pktfig parameter of the same name   [blank]
|
| xvar             Passed as %tu_pktfig parameter of the same name   pcwnlrt pcatmu
...
| xlabel           Passed as %tu_pktfig parameter of the same name   Actual Relative Time (units)
| xref             Passed as %tu_pktfig parameter HREF               [blank]
|
| yvar             Passed as %tu_pktfig parameter of the same name   pcstimsn pcstresu
...
|
| byvars           Passed as %tu_pktfig parameter of the same name   &g_trtgrp=&g_trtcd
| zvar             Passed as %tu_pktfig parameter of the same name   &g_subjid
| zrepeatvar       Passed as %tu_pktfig parameter of the same name   [blank]
| legendyn         Passed as %tu_pktfig parameter of the same name   N
...
| formats          Passed as %tu_pktfig parameter of the same name   pcwnlrt pcstimsn best6.
|
...
| symbolValue      Passed as %tu_pktfig parameter of the same name   [blank]
...
%macro td_pkcf6(
  ...
  ,style = SPAGHETTI                            /* Graph type (individual/mean/median/spaghetti) */    
  ,bars = NONE                                  /* Bars to be applied to graph            */
  ,postsubset =                                 /* Subset data prior to plotting?         */
  ,xvar=pcwnlrt pcatmu                          /* X-axis and (optional) units            */
  ...
  ,xlabel = Actual Relative Time (units)        /* X-axis label                           */
  ,xref =                                       /* X-axis reference line                  */
  ,yvar=pcstimsn pcstresu                       /* Y-axis and (optional) units            */
  ...
  ,byvars = &g_trtgrp=&g_trtcd                  /* By variables (i.e. page)               */
  ,zvar = &g_subjid                             /* 3rd Classification var (i.e. line)     */
  ...
  ,formats = pcwnlrt pcstimsn best6.            /* Formats to be applied to plot axes     */
  ...
  ,symbolValue =                                /* Symbols for symbol stmts */
