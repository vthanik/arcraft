...
*  Date:            04aug2003
*
*  Macro purpose:   display macro to generate IDSL vs4 listing
*
...
*                  provided here.                                      %str(varsin=age sex race ,varout=st_vs_asr4, sepc=/   ) 
*  stackvar2       Additional stacked variables (ref: stackvar1)       %str(varsin=&g_centid &g_subjid, varout=st_vs_cs4, sepc=/)
*  stackvar3       Additional stacked variables (ref: stackvar1) 
*  - stackvar15                                                        blank
...
*                  string                                              DD dataset for VS4 listing
...
*                  COLUMN statement syntax                             &g_trtcd &g_trtgrp &g_centid &g_subjid st_vs_cs4 st_vs_asr4 visitnum visit vsdt vsactdy sysbp diabp
...
*                  that are also defined with COLUMNS                  &g_trtcd &g_trtgrp &g_centid &g_subjid st_vs_cs4 st_vs_asr4 visitnum visit vsdt vsactdy 
...
*                  rows in the display.                                &g_trtcd visitnum &g_centid &g_subjid
...
*                  width of  column header)                            &g_trtgrp st_vs_cs4 st_vs_asr4 visit
...
*                  width, width of column header)                      &g_trtgrp 10 st_vs_cs4 7 st_vs_asr4 15 visit 12 vsdt 10 vsactdy 5 sysbp 8 diabp 9
...
%macro td_vs4(
         ...
         stackvar1      =%str(varsin=age sex race ,varout=st_vs_asr4, sepc=/ ) , /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))      */
         stackvar2      =%str(varsin=&g_centid &g_subjid, varout=st_vs_cs4, sepc=/), /* Create stacked variables (e.g., stackvar1=%str(varsin=invid subjid, varout=st_inv_subj,sepc=/,splitc=~))       */
         ...
         dddatasetlabel =DD dataset for VS4 listing, /* Label to be applied to the DD dataset  */
         ...
         columns        =&g_trtcd &g_trtgrp &g_centid &g_subjid st_vs_cs4 st_vs_asr4 visitnum visit vsdt vsactdy sysbp diabp, /* Columns to be included in the listing (plus spanned headers)  */
         ordervars      =&g_trtcd &g_trtgrp &g_centid &g_subjid st_vs_cs4 st_vs_asr4 visitnum visit vsdt vsactdy, /*  Order variables  */
         ...
         noprintvars    =&g_trtcd visitnum &g_centid &g_subjid, /* No print variables, used to order the display */
         byvars         =,          /* By variables */
         flowvars       =&g_trtgrp st_vs_cs4 st_vs_asr4 visit, /* Variables with flow option */
         widths         =,          /* Column widths */
         defaultwidths  =&g_trtgrp 10 st_vs_cs4 7 st_vs_asr4 15 visit 12 vsdt 10 vsactdy 5 sysbp 8 diabp 9, /* List of default column widths */
         skipvars       =&g_centid &g_subjid, /*  Variables whose change in value causes the display to skip a line */
