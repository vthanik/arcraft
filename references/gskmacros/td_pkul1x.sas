...
| Date:           15-Jun-2005
|
| Macro purpose:  Display macro to create IDSL PKOne table PKUL1X for Cross Over Group studies
|
...
|
| COLUMNS         Passed as %tu_list parameter of the same name.       &g_centid &g_subjid st_cs pernum 
|                                                                      &g_ptrtcd st_tp ptmnum ptm pcstresc
|                                                                      pcvol pcuae pcph
|
...
| PAGEVARS
| 
| DDDATASETLABEL  Passed as %tu_list parameter of the same name.       DD Listing for a listing PKUL1X (Req)
|
| DEFAULTWIDTHS   Passed as %tu_list parameter of the same name.       st_cs 8 st_tp 10 ptm 8 pcstresc 15  
|                                                                      pcvol 8 pcuae 8 pcph 8 (Req) 
|
...
|
| NOPRINTVARS     Passed as %tu_list parameter of the same name.       ptmnum pernum &g_ptrtcd &g_centid &g_subjid (Req)
|
...
|
| ORDERVARS       Passed as %tu_list parameter of the same name.       &g_centid &g_subjid st_cs pernum &g_ptrtcd 
|                                                                      st_tp ptmnum ptm  (Req)
|
...
|                              GTW.01.003.b:  Added trim and left to display of pcstresc
|
|-----------------------------------------------------------------------------------
| Change Log
|
...
%macro td_pkul1x(
   ...
   columns        =&g_centid &g_subjid st_cs pernum &g_ptrtcd st_tp ptmnum ptm pcstresc pcvol pcuae pcph, /* Column parameter */
   ...
   dddatasetlabel = DD dataset for a listing PKUL1X, /* Label to be applied to the DD dataset */
   defaultwidths  =st_cs 8 st_tp 10 ptm 8 pcstresc 15 pcvol 8 pcuae 8 pcph 8, /* List of default column widths */
   ...
   noprintvars    =ptmnum pernum &g_ptrtcd &g_centid &g_subjid, /* No print vars (usually used to order the display) */
   ...
   ordervars      =&g_centid &g_subjid st_cs pernum &g_ptrtcd st_tp ptmnum ptm, /* Order variables */
   ...
   | GTW.01.003.b - Added trim and left                       
   /-------------------------------------------------------------------------------*/    
