...
| Date:               23May2005
|
| Macro Purpose:      A macro to create Concomidant Medication Summary CM8.
|
...
|                                                                                         
| COLUMNS             A PROC REPORT column statement specification.     summaryLevel      
|                     Including spanning titles and variable names      tt_pct999 cmdecod  
...
|                                                                                         
| DEFAULTWIDTHS       Specifies column widths for all variables not     cmdecod 40
|                     listed in the WIDTHS parameter                    tt_ac: 12      
...
|                                                                                         
| DESCENDING          List of ORDERVARS that are given the PROC REPORT  tt_pct999         
...
|                                                                                         
| DSETINNUMER         Input dataset containing data to be counted to    ardata.cmanal(where
|                     obtain the numerator.                             =(display2 eq 1))
|                                                                                         
|                     Valid Values:                                                       
|                                                                                         
|                     Valid sas dataset name                                              
|                                                                                         
| FLOWVARS            Variables to be defined with the flow option      cmdecod            
|                     Valid values: one or more variable names that                       
|                     are also defined with COLUMNS                                       
...
|                     DSETINDENOM                                                         
|                                                                                         
| GROUPBYVARSNUMER    Variables in DSETINNUMER to group the data by,    &g_trtcd (cmdecod=          
|                     along with ACROSSVAR, when counting to obtain     'Any medication')  
|                     the numerator. Additionally a set of brackets     cmdecod 
|                     may be inserted within the variables to generate   
...
|                     are also defined with COLUMNS                                       
|                                                                                         
| LABELS              Variables and their label for display. For use    cmdecod='Ingredient' 
...
|                     defined as NOPRINT                                                  
|                                                                                         
| NOPRINTVARS         Variables listed in the COLUMN parameter that     tt_ac999              
...
|                     REPORT define statement attribute ORDER           tt_pct999 cmdecod      
|                     Valid values: one or more variable names that       
|                     are also defined with COLUMNS                                       
|                                                                                         
...
|                     Valid values: positive integer                                      
|                                                                                         
| SKIPVARS            Variables whose change in value causes the        summaryLevel            
...
%macro td_cm8b (
   ...
   COLUMNS             =summaryLevel tt_pct999 cmdecod tt_ac:, /* Columns to be included in the listing (plus spanned headers) */                                                                                                           
   ...
   DDDATASETLABEL      =DD dataset for CM8 table, /* Label to be applied to the DD dataset */                                                                                                                                                                
   DEFAULTWIDTHS       =cmdecod 40 tt_ac: 12, /* List of default column widths */                                                                                                                                                                             
...
DSETINNUMER         =ardata.cmanal(where=(display2 eq 1)),
/* Input dataset containing AE data to be counted to obtain the numerator. */
   FLOWVARS            =cmdecod,           /* Variables with flow option */                                                                                                                                                                                  
   ...
   GROUPBYVARSNUMER    =&g_trtcd (cmdecod='Any medication') cmdecod, /* Variables in DSETINNUMER to group the data by when counting to obtain the numerator.*/ 
   IDVARS              = ,                 /* Variables to appear on each page of the report */                                                                                                                                                              
   LABELS              =cmdecod='Ingredient', /* Label definitions (var=var label) */                                                                                                                                                    
   LEFTVARS            =,                  /* Left justify variables */                                                                                                                                                                                      
   LINEVARS            =,                  /* Order variables printed with LINE statements */                                                                                                                                                                
   NOPRINTVARS         =tt_ac999 summaryLevel tt_pct999, /* No print variables, used to order the display */                                                                                                                                       
   ...
   ORDERVARS           =summaryLevel tt_pct999 cmdecod, /* Order variables */                                                                                                                                                                
   ...
   SKIPVARS            =summaryLevel,      /* Variables whose change in value causes the display to skip a line */                                                                                                                                           
