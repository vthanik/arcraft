...
*  Date:            22sep2003
*
*  Macro purpose:   display macro to generate IDSL ie4 listing
*
...
*                  string                                              DD dataset for IE4 listing
...
*                  COLUMN statement syntax                             &g_centid &g_subjid &g_trtgrp iecrtycd iecrttyp iecrtnum
...
*                  that are also defined with COLUMNS                  &g_centid &g_subjid &g_trtgrp iecrtycd iecrttyp iecrtnum
...
*                  width of  column header)                            &g_trtgrp ietext iecrttyp
...
*                  width, width of column header)                      &g_centid 6 &g_subjid 6 &g_trtgrp 10 iecrttyp 10 ietext 50
...
%macro td_ie4(
   ...
   dddatasetlabel =DD dataset for IE4 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_centid &g_subjid &g_trtgrp iecrtycd iecrttyp iecrtnum ietext, /* Columns to be included in the listing (plus spanned headers)  */
   ordervars      =&g_centid &g_subjid &g_trtgrp iecrtycd iecrttyp iecrtnum, /*  Order variables  */
   ...
   noprintvars    =iecrtycd iecrtnum, /* No print variables, used to order the display */
   byvars         =,          /* By variables */
   flowvars       =&g_trtgrp ietext iecrttyp,     /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =&g_centid 6 &g_subjid 6 &g_trtgrp 10 iecrttyp 10 ietext 50, /* List of default column widths */
