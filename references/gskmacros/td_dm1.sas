...
| Date          : Aug 2003
|
| Macro Purpose : display macro to generate IDSL dm1 listing
|
...
|              parameters required for tu_sumstatsinrows   codedecodevarpairs=&g_trtcd &g_trtgrp ethnic ethniccd)
|              The following style shall be used:
|              segment1 = %str(parm1=value1, parm2=value2
|              Where parm1 and parm2 are both parameters of
|              tu_freq or tu_sumstatsinrows.
...
|
| XMLDEFAULTS  Full directory path and filename of dm1.xml     &g_refdata\tr_dm1_defaults.xml
...
|     DDDATASETLABEL=DD dataset for td_dm1 display, DEFAULTWIDTHS=(Blank), DESCENDING=(Blank),
|     DISPLAY=Y, FLOWVARS=_All_, FORMATS=(Blank), IDVARS=(Blank), LABELVARSYN= Y, LABELS=(Blank),
...
|
| Modified By :             Lee Seymour
| Date of Modification :    21-Oct-2003
| New Version Number :      1/4
| Modification ID :
| Reason For Modification : Amended default for acrossvar and acrossvardecode
|                           changed to &g_trtcd and &g_trtgrp respectively
|
...
|                              splitchar. overallsummary and stackvar3-15 to %tu_list required  
|                              by change request HRT0021
...
|                           incorporated into the multisegments macro itself. Also changed 
|                           tt_result1-tt_result9999 to tt_result0001-tt_result9999 in the 
|                           default value for the widths parameter. Added new parameters,
...
dsetin = ardata.demo, /* DSETIN for all segments.*/
