...
*  Date:          17sep2003
*
*  Macro purpose: display macro to generate IDSL es2 listing
*
...
*                  string                                              DD dataset for ES2 listing
...
*                  COLUMN statement syntax                             &g_trtcd &g_trtgrp &g_centid &g_subjid dsdt dsactdy esreason   
...
*                  width of  column header)                            &g_trtgrp dsdt esreason
...
*                  width, width of column header)                      &g_trtgrp 18 &g_centid 6 &g_subjid 6 dsdt 10 dsactdy 5 esreason 35
...
%macro td_es2(
    ...
    dddatasetlabel =DD dataset for ES2 listing, /* Label to be applied to the DD dataset  */
    ...
    columns        =&g_trtcd &g_trtgrp &g_centid &g_subjid dsdt dsactdy esreason  , /* Columns to be included in the listing (plus spanned headers)  */
    ...
    byvars         =,          /* By variables */
    flowvars       =&g_trtgrp dsdt esreason, /* Variables with flow option */
    widths         =,          /* Column widths */
    defaultwidths  =&g_trtgrp 18 &g_centid 6 &g_subjid 6 dsdt 10 dsactdy 5 esreason 35, /* List of default column widths */
    ...
    leftvars       =dsdt,      /* Left justify variables   */ 
 ...
 proc sql;
    create table &l_prefix.es22 as select *,
