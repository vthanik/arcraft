...
|                     other elements of valid PROC REPORT COLUMN        tt_pct999 cmdecod            
...
|                     listed in the WIDTHS parameter                    cmdecod 40 tt_ac: 12      
...
|                     along with ACROSSVAR, when counting to obtain     cmdecod= 'Any medication'; 
...
|                     records containing summary counts grouped by      cmdecod= 'Any  
...
|                     values in the grouping variables by specifying    cmdecod= 'Any  
|                     variable value pairs within brackets, seperated   medication') cmdecod) 
...
|                     Valid values: one or more variable names that     summaryLevel  
|                     are also defined with COLUMNS                     tt_pct999 cmdecod                  
|                                                                                         
...
|                     The attributes of the last variable in the list   cmdecod                  
...
%macro td_cm7b(
   ...
   COLUMNS             =tt_spsort cmatc1 tt_spsort2 cmatc2 summaryLevel tt_pct999 cmdecod tt_ac:, /* Column parameter */
...
DEFAULTWIDTHS       =cmatc1 40 cmatc2 40 cmdecod 40 tt_ac: 12,
...
FLOWVARS            =cmdecod cmatc1 cmatc2,
/* Variables with flow option */
   ...
   GROUPBYVARSNUMER    =&g_trtcd %nrstr((cmdecod= 'Any medication';cmatc1='DUMMY';cmatc2='DUMMY') cmatc1 (cmdecod= 'Any medication';cmatc2='DUMMY1') cmatc2 (cmdecod= 'Any medication') cmdecod), 
   IDVARS              = ,                 /* Variables to appear on each page of the report */                                                                                                                                                              
   LABELS              =cmdecod='ATC Level 1~  ATC Level 2~     Ingredient', /* Label definitions. */
...
ORDERVARS           =tt_spsort tt_spsort2 cmatc1 cmatc2 summaryLevel tt_pct999 cmdecod,
/* Order variables */
...
SHARECOLVARS        =cmatc1 cmatc2 cmdecod,
