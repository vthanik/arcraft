...
| Date:             10DEC2004
|
| Macro Purpose:    A macro to create IDSL standard display DM9
|
...
|                     DSETIN plus other elements of valid PROC REPORT   &g_subjid raceccd
...
|                     dataset                                           for listing
|                     Valid values: a non-blank text string             DM9
|
...
%macro td_dm9(
   ...
   COLUMNS             =&g_trtcd &g_trtgrp &g_centid &g_subjid raceccd racec, /* Columns to be included in the listing (plus spanned headers) */
   ...
   DDDATASETLABEL      =DD dataset for listing DM9, /* Label to be applied to the DD dataset */
