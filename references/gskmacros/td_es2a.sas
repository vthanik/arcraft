...
| Date:               01Jun2007
|
| Macro purpose:      Display macro to generate new IDSL listing ES2
|
...
|                     Valid values: one or more variable names     &g_subjid dsstdt
|                     from DSETIN plus other elements of valid     dsstdy dsrscd
|                     PROC REPORT COLUMN statement syntax, but     dsrs dssbrscd
|                     not including report_item=alias syntax       dssbrs
|
...
|                     columns and will usually be defined by the   &g_centid 8
|                     DD macro.  This parameter specifies column   &g_subjid 8
|                     widths for all variables not listed in the   dsstdt 10 dsstdy 5
|                     WIDTHS parameter.                            dsrs 25 dssbrs 25
...
|
| FLOWVARS            Variables to be defined with the flow        &g_trtgrp dsrs
|                     option.                                      dssbrs
|                     Valid values: one or more variable names
|                     from DSETIN that are also defined with
|                     COLUMNS
...
|
| NOPRINTVARS         Variables listed in the COLUMN parameter     &g_trtcd dsrscd
...
|                     ORDER                                        &g_centid
|                     Valid values: one or more variable names     &g_subjid dsstdt
|                     from DSETIN that are also defined with       dsstdy dsrscd
|                     COLUMNS                                      dsrs dssbrscd
|
...
%macro td_es2a(
   ...
   COLUMNS             =&g_trtcd &g_trtgrp &g_centid &g_subjid dsstdt dsstdy dsrscd dsrs dssbrscd dssbrs, /* Column parameter */
   ...
   DDDATASETLABEL      =DD dataset for new ES2 listing, /* Label to be applied to the DD dataset */
   DEFAULTWIDTHS       =&g_trtgrp 15 &g_centid 8 &g_subjid 8 dsstdt 10 dsstdy 5 dsrs 25 dssbrs 25, /* List of default column widths */
   DESCENDING          =,                  /* Descending ORDERVARS */
   DSETIN              =ardata.ds,         /* Input dataset */
   FLOWVARS            =&g_trtgrp dsrs dssbrs, /* Variables with flow option */
   ...
   NOPRINTVARS         =&g_trtcd dsrscd dssbrscd, /* No print vars (usually used to order the display) */
   ...
   ORDERVARS           =&g_trtcd &g_trtgrp &g_centid &g_subjid dsstdt dsstdy dsrscd dsrs dssbrscd, /* Order variables */
