...
|                    Table (PKPT1) as defined in the ISDL Standard Data Displays document.
...
|
| CENTREVARS               Passed as %tu_sumstatsinrows parameter of the same name.  clm visit (Req) 
|
...
|
| COLUMNS                  Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_trtcd &g_trtgrp tt_bnnm 
|                                                                                    visitnum visit n mean clm std 
|                                                                                    median min max (Req)
|
...
|
| DDDATASETLABEL           Passed as %tu_sumstatsinrows parameter of the same name.  DD Dataset for Table PKPT1P (Req)
|
| DEFAULTWIDTHS            Passed as %tu_sumstatsinrows parameter of the same name.  pppar 10 &g_trtgrp 9 tt_bnnm 2 visit 15
|                                                                                    clm 18 (Req)
|
...
|
| FLOWVARS                 Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_trtgrp visit (Req)
| 
...
|
| GROUPBYVARSANALY         Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_trtcd &g_trtgrp
|                                                                                    visitnum visit (Req)
|
| IDVARS                   Passed as %tu_sumstatsinrows parameter of the same name.  (blank) (Opt)
|
| LABELS                   Passed as %tu_sumstatsinrows parameter of the same name.  pppar='Param.' &g_trtgrp="Trt." 
...
|
| NOPRINTVARS              Passed as %tu_sumstatsinrows parameter of the same name.  &g_trtcd visitnum (Req)
|
| NOWIDOWVAR               Passed as %tu_sumstatsinrows parameter of the same name.  &g_trtcd (Opt)  
|
...
|
| ORDERVARS                Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_trtcd &g_trtgrp 
|                                                                                    tt_bnnm visitnum visit (Req)
|
...
%MACRO td_pkpt1p(
   ...
   BYVARS                   =,                     /* By variables */            
   CENTREVARS               =clm visit,                  /* Centre justify variables */            
   CODEDECODEVARPAIRS       =&g_trtcd &g_trtgrp visitnum visit, /* Code and Decode variables in pairs*/
   COLSPACING               =1,                    /* Overall spacing value. */          
   COLUMNS                  =pppar &g_trtcd &g_trtgrp tt_bnnm visitnum visit n mean clm std median min max, /* Column parameter */
   ...
   DDDATASETLABEL           =DD Dataset for PKPT1P, /* The variables whose values define the subgroup combinations for the analysis */ 
   DEFAULTWIDTHS            =pppar 10 &g_trtgrp 9 tt_bnnm 2 visit 15 clm 18, /* List of default column widths */
   ...
   FLOWVARS                 =pppar &g_trtgrp visit,/* Variables with flow option */
   ...
   IDVARS                   =,                      /* ID variables */
   LABELS                   =pppar='Param.' &g_trtgrp="Trt." %nrstr(clm='95% CI~(Lower,Upper)' ),  /* Label definitions. */
   ...
   NOPRINTVARS              =&g_trtcd visitnum,     /* No print vars (usually used to order the display) */
   NOWIDOWVAR               =&g_trtcd,              /* Not in version 1 */
   ORDERDATA                =,                      /* ORDER=DATA variables */
   ORDERFORMATTED           =,                      /* ORDER=FORMATTED variables */
   ORDERFREQ                =,                      /* ORDER=FREQ variables */
   ORDERVARS                =pppar &g_trtcd &g_trtgrp tt_bnnm visitnum visit,  /* Order variables */
   ...
   STATSDPS                 =std +2 mean +1 median +1 clm +1,  /* Decimal precision for summary stats */ 
   STATSLIST                =n mean clm std median min max,   /* List of required summary statistics */
