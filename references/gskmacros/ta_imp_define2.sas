/* User Guide page 325.                             */
/* Convert define.xml into 54 meetadata             */
/* datasets.                                        */

%macro ta_imp_define2(
);
...
%GLOBAL _cstSrcStandard _cstSrcStandardVersion _cstDefineFile;
/*%let _cstSrcStandardVersion=&pVer;*/
