...
|                     Valid values: one or more variable names plus     tt_pct999 cmdecod  
...
|                                                                                         
| DEFAULTWIDTHS       Specifies column widths for all variables not     cmatc1 40 cmdecod  
...
|                     obtain the numerator.                             e=(display2 eq 1))
|                                                                                         
|                     Valid Values:                                                       
|                                                                                         
|                     Valid sas dataset name                                              
|                                                                                         
| FLOWVARS            Variables to be defined with the flow option      cmdecod cmatc1 
|                     Valid values: one or more variable names that                       
|                     are also defined with COLUMNS                                       
...
|                     may be inserted within the variables to generate  cmdecod= 'Any      
|                     records containing summary counts grouped by      medication')      
|                     variables specified to the left of the brackets.  cmatc1 (cmdecod=   
|                     Summary records created may be populated with     'Any medication') 
|                     values in the grouping variables by specifying    cmdecod            
...
|                     are also defined with COLUMNS                                       
|                                                                                         
| LABELS              Variables and their label for display. For use    cmdecod='ATC Level 
...
|                     Valid values: one or more variable names that     tt_pct999 cmdecod  
|                     are also defined with COLUMNS                                       
|                                                                                         
...
|                     are also defined with COLUMNS                                       
|                                                                                         
| SHARECOLVARS        List of variables that will share print space.    cmatc1 cmdecod     
...
%macro td_cm1b(
   ...
   COLUMNS             =tt_spsort cmatc1 summaryLevel tt_pct999 cmdecod tt_ac:, /* Columns to be included in the listing (plus spanned headers) */                                                                                                           
...
DEFAULTWIDTHS       =cmatc1 40 cmdecod 40 tt_ac: 12,
...
/* Input dataset containing AE data to be counted to obtain the numerator. */
   FLOWVARS            =cmdecod cmatc1,     /* Variables with flow option */                                                                                                                                                                                  
   ...
   GROUPBYVARSNUMER    =&g_trtcd (cmatc1='DUMMY' %nrstr(;) cmdecod= 'Any medication') cmatc1 (cmdecod= 'Any medication') cmdecod, /* Variables in DSETINNUMER to group the data by when counting to obtain the numerator.*/ 
   IDVARS              = ,                 /* Variables to appear on each page of the report */                                                                                                                                                              
   LABELS              =cmdecod='ATC Level 1~   Ingredient', /* Label definitions (var=var label) */                                                                                                                                                    
   ...
   ORDERVARS           =tt_spsort cmatc1 summaryLevel tt_pct999 cmdecod, /* Order variables */                                                                                                                                                                
   ...
   SHARECOLVARS        =cmatc1 cmdecod,     /* Order variables that share print space */                                                                                                                                                                      
