...
| Date:            28-Jan-2009
|
| Macro Purpose:   To create standard: Median +/-range [Analyte] [Matrix] Concentration-Time Plots (Linear and Semi-log)
|
...
| style            Passed as %tu_pktfig parameter of the same name   MEDIAN
| bars             Passed as %tu_pktfig parameter of the same name   RANGE
...
| symbolInterpol   Passed as %tu_pktfig parameter of the same name   hilocj
|
...
%macro td_pkcf5(
  ...
  ,style = MEDIAN                               /* Graph type (individual/mean/median/spaghetti) */    
  ,bars = RANGE                                 /* Bars to be applied to graph            */
  ...
  ,symbolInterpol = hilocj                      /* Interpolations for symbol stmts        */
  );
