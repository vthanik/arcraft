...
/ Date: 15OCT2003
/
/ Macro Purpose: A macro to create Includion/Exclusion Criteria Display 2
/
...
/
/COLUMNS             A PROC REPORT column statement             iecrtycd iecrttyp summaryLevel iecrtnum ietext tt_ac999
...
/
/FLOWVARS            Variables to be defined with the flow      iecrttyp ietext
/                    option
/                    Valid values: one or more variable names
/                    from DSETIN that are also defined with
/                    COLUMNS
...
/ Date of Modification:    03 June 2004
/ New version number:      1/2
/ Modification ID:
/ Reason For Modification: Amend the layout of the macro declaration to
/                          avoid problems when the macro is parsed by the
/                          HARP Application whilst being checked into the
/                          Reporting Tools Library.
/*******************************************************************************
...
%macro td_ie2(
         ...
         columns                 =  iecrtycd iecrttyp summaryLevel iecrtnum ietext tt_ac999, /* Columns to be included in the listing (plus spanned headers) */
         ...
         dddatasetlabel          =  DD dataset for ie2 table,/* Label to be applied to the DD dataset */
         ...
         flowvars                =  iecrttyp ietext,   /* Variables with flow option */
