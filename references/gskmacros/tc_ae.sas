...
| Date:            07-May-2004
|
| Macro Purpose:   Adverse events wrapper macro
|
...
| Reason For Modification:  Changed the order of call of %tu_rantrt and 
|                           %tu_decode. Call %tu_rantrt after %tu_timslc
|                           Call %tu_decode after %tu_derive.   
|                           Added new parameter &REFDAT and &REFTIM   
|*******************************************************************************   
| Modified By:              Yongwei Wang
...
|                              passed to %tu_decode
|                           5. Added parameter DURATIONUNITS, which will be 
|                              passed to %tu_derive
|*******************************************************************************
| Modified By:
...
%macro tc_ae (
 ...
 %local prefix;
 %let prefix = _tc_ae;   /* Root name for temporary work datasets */
 ...
 %do;
    %tu_derive (
         ...
         tmslicedset       = &tmslicedset,   
         visitdset         = &visitdset,                                 
         domaincode        = ae,                     /* Domain Code - type of dataset */
