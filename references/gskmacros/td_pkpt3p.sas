...
|                    Table (PKPT3P) as defined in the ISDL Standard Data Displays document.
...
|
| CENTREVARS               Passed as %tu_sumstatsinrows parameter of the same name.  clmlog visit (Req)
|
...
|
| COLUMNS                  Passed as %tu_sumstatsinrows parameter of the same name.  pppar &g_trtcd &g_trtgrp tt_bnnm visitnum 
|                                                                                     visit n geomean clmlog stdlog cvblog  (Req) 
|
...
|
| DDDATASETLABEL           Passed as %tu_sumstatsinrows parameter of the same name.  DD Dataset for Table PKPT3P (Req)
|
| DEFAULTWIDTHS            Passed as %tu_sumstatsinrows parameter of the same name.  pppar 10 &g_trtgrp 9 tt_bnnm 2 visit 10 clmlog 17
...
|
| NOWIDOWVAR               Passed as %tu_sumstatsinrows parameter of the same name.  &g_trtcd (Req)  
|
...
%MACRO td_pkpt3p(
   ...
   BYVARS                   =,                     /* By variables */
   CENTREVARS               =clmlog visit,         /* Centre justify variables */
   CODEDECODEVARPAIRS       =&g_trtcd &g_trtgrp visitnum visit,/* Code and Decode variables in pairs*/
   COLSPACING               =1,                    /* Overall spacing value. */
   COLUMNS                  =pppar &g_trtcd &g_trtgrp tt_bnnm visitnum visit n geomean clmlog stdlog cvblog,/* Column parameter */
   ...
   DDDATASETLABEL           =DD dataset for PKPT3P, /* Label to be applied to the DD dataset */
   DEFAULTWIDTHS            =pppar 10 &g_trtgrp 9 tt_bnnm 2 visit 10 clmlog 17, /* List of default column widths */
