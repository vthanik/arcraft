...
|                                                                                         
| COLUMNS             A PROC REPORT column statement specification.     cmatc1 cmcomp     
...
|                                                                                         
| DEFAULTWIDTHS       Specifies column widths for all variables not     cmatc1 28 cmcomp  
...
|                     where label for display differs to the label on   cmcomp='Ingredient' 
|                     the DSETIN                                                          
...
|                     attribute order=internal                                            
|                                                                                         
| ORDERVARS           List of variables that will receive the PROC      cmatc1 cmcomp     
...
|                           4.Added call of %tu_tidyup
|                           5.Added call of %tu_nobs to check if &dsetin exist
|                           6.Modified the message after calling %tu_chkvarsexist
|-----------------------------------------------------------------------------------------
| Modified by:              Yongwei Wang (YW62951)
...
%macro td_cm6(                      
   ...
   COLUMNS             =cmatc1 cmcomp cmterm, /* Columns to be included in the listing (plus spanned headers) */                                                                                                                                             
   ...
   DEFAULTWIDTHS       =cmatc1 28 cmcomp 30 cmterm 30, /* List of default column widths */                                                                                                                                                                   
...
LABELS              =cmatc1='ATC Level 1' cmcomp='Ingredient',
/* Label definitions (var=var label) */
   ...
   ORDERVARS           =cmatc1 cmcomp cmterm, /* Order variables */                                                                                                                                                                                          
   ...
   /* YW002: call %tu_getdata to subset input data set */
