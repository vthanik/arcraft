...
| -----------------------------------------------------------------------------------
| DSETIN              Specifies the LBIOPSY-format SI dataset      dmdata.lbiopsy
|                     which needs to be transformed into a
|                     LBIOPSY-format A&R dataset.
|                     Valid values: valid dataset name
|
| DSETOUT             Specifies the name of the output dataset to  ardata.lbiopsy
|                     be created.
|                     Valid values: valid dataset name
|
...
|                     Valid values: Y, N
|
| DECODERENAME        DECODERENAME      By default, a coded        LPORRS=LPORRES
|                     variable named  ZZZcd will produce a
...
|                     VISITNUM based on the liver biopsy start 
|                     date?
|                     Valid values: Y, N
|
| REFDAT              Specify a reference date variable name to    lpdt
...
|   Name         Req/Opt  Description
|   ------------ -------  ----------------------------------------------------
|   &DSETOUT     Req      Parameter specified IDSL standard LBIOPSY A&R dataset
|----------------------------------------------------------------------------------
...
%macro tc_lbiopsy (
   DSETIN              = dmdata.lbiopsy,   /* Input dataset name */
   DSETOUT             = ardata.lbiopsy,   /* Output dataset name */
   ...
   DECODERENAME        =LPORRS=LPORRES,    /* List of renames for decoded variables */
   ...
   RECALCVISITYN       =Y,                 /* Recalculate VISIT based on the liver biopsy start date */
   REFDAT              =lpdt,              /* Reference date variable name for recalculating visit */
   ...
   %let prefix = _tc_lbiopsy;   /* Root name for temporary work datasets */
