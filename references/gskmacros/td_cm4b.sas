...
/* List of default column widths */
   ...
   STACKVAR3           =%str(varsin=cmatc1 cmdecod cmterm,varout=ST_CM_ADT4,sepc=/), /* Create stacked variables */                                          
