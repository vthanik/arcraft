...
/ Date: 15OCT2003
/
/ Macro Purpose: A macro to create Includion/Exclusion Criteria Display 1
/
...
/
/COLUMNS             A PROC REPORT column statement             iecrtycd iecrttyp summaryLevel iecrtnum ietext tt_ac:
...
/
/DEFAULTWIDTHS       Specifies column widths for all            ietext 40
...
/
/DSETINNUMER         Input dataset containing data to be        ardata.elig
/                    counted to obtain the numerator.
/
/                    Valid Values: Valid sas dataset name
/
/FLOWVARS            Variables to be defined with the flow      iecrtnum ietext
/                    option
/                    Valid values: one or more variable names
/                    from DSETIN that are also defined with
/                    COLUMNS
...
/                    data by, along with ACROSSVAR, when        (iecrttyp='DUMMY'%nrstr(&sc)
/                    counting to obtain the numerator.           ietext='Any criteria deviations')
/                    Additionally a set of brackets may be      iecrtycd iecrttyp iecrtnum ietext
...
/
/NOPRINTVARS         Variables listed in the COLUMN parameter   iecrtycd summaryLevel iecrtnum
...
/                    define attribute order=internal
/
/ORDERVARS           List of variables that will receive the    iecrtycd
/                    PROC REPORT define statement attribute     iecrttyp
/                    ORDER                                      summaryLevel
/                    Valid values: one or more variable names   iecrtnum ietext
/                    from DSETIN that are also defined with
/                    COLUMNS
/
...
/                    COLUMNS
/
/SHARECOLVARS        List of variables that will share print    iecrttyp ietext
/                    space. The attributes of the last
/                    variable in the list define the column
/                    width and flow options
/                    Valid values: one or more variable names
/                    from DSETIN
/                    ie1 shows an example of this style of
/                    output
...
/                    Valid values: positive integer
/
/SKIPVARS            Variables whose change in value causes     iecrttyp
...
/                           Removed parameter SPSORTGROUPBYVARSDENOM, 
/                           SPSORTGROUPBYVARSNUMER, SPSORTRESULTSTYLE. 
...
/ Reason For Modification : Added SPSORTGROUPBYVARSDENOM, SPSORTGROUPBYVARSNUMER, 
/                           SPSORTRESULTSTYLE back because backward compatibility 
/                           concern.
/*******************************************************************************
/ Modified By :             Yongwei Wang
...
/ Modification ID :         N/A 
/ Reason For Modification : Fixed a typo in parameters, after roll-back 
/*******************************************************************************
/ Modified By:
...
%macro td_ie1
      (
         ...
         columns                 =  iecrtycd iecrttyp summaryLevel iecrtnum ietext tt_ac:, /* Columns to be included in the listing (plus spanned headers) */
         ...
         dddatasetlabel          =  DD dataset for IE1 table,/* Label to be applied to the DD dataset */
         defaultwidths           =  ietext 40,  /* List of default column widths */
         ...
         dsetinNumer             =  ardata.elig,       /* Input dataset containing data to be counted to obtain the numerator. */
         flowvars                =  iecrtnum ietext,   /* Variables with flow option */
         ...
         groupByVarsNumer        =  &g_trtcd (iecrttyp='DUMMY'%nrstr(&sc) ietext='Any criteria deviations') iecrtycd iecrttyp iecrtnum ietext,/* Variables in DSETINNUMER to group the data by when counting to obtain the numerator. */
         ...
         noprintVars             =  iecrtycd summaryLevel iecrtnum,     /* No print variables, used to order the display */
         ...
         ordervars               =  iecrtycd iecrttyp summaryLevel iecrtnum ietext,     /* Order variables */
         ...
         sharecolvars            =  iecrttyp ietext,   /* Order variables that share print space. */
         sharecolvarsindent      =  2,                 /* Indentation factor */
         skipvars                =  iecrttyp,          /* Variables whose change in value causes the display to skip a line */
         ...
         spSortResultStyle       =  ,                  /* Special sort: the appearance style of the result data that will be sed to sequence the report. */
