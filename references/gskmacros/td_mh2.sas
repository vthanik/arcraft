...
*  Date:           18sep2003
*
*  Macro purpose:  display macro to generate IDSL mh2 listing
*
...
*                  string                                              DD dataset for MH2 listing
...
*                  COLUMN statement syntax                             &g_trtcd &g_trtgrp &g_centid &g_subjid mhbodsys mhterm   
...
*                  that are also defined with COLUMNS                  &g_trtcd &g_trtgrp &g_centid &g_subjid mhbodsys   
...
*                  width, width of column header)                      &g_trtgrp 12 &g_centid 6 &g_subjid 6  mhbodsys 25 mhterm 32
...
%macro td_mh2(
   ...
   dddatasetlabel =DD dataset for MH2 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_trtcd &g_trtgrp &g_centid &g_subjid mhbodsys mhterm, /* Columns to be included in the listing (plus spanned headers)  */
   ordervars      =&g_trtcd &g_trtgrp &g_centid &g_subjid mhbodsys, /*  Order variables  */
   ...
   defaultwidths  =&g_trtgrp 12 &g_centid 6 &g_subjid 6  mhbodsys 25 mhterm 32, /* List of default column widths */
