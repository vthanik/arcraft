...
| Date:            08-Jul-2004
|
| Macro Purpose:   Concomitant Medications Analysis (CMANAL) wrapper macro
|
...
|                    into a CMANAL-format A&R dataset.
|                    Valid values: valid dataset name
|
| DSETOUT            Specifies the name of the output       REQ      ARDATA.CMANAL
...
%macro tc_cmanal (
 ...
 %local prefix;
 %let prefix = _tc_cmanal;   /* Root name for temporary work datasets */
