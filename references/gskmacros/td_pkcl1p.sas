...
|
|  Macro purpose:   Display macro to generate IDSL PKCL1P listing
...
|                   DD dataset Valid values: a non-blank text           pkcl1p listing (Req)
|                   string
|
...
|
|  COLUMNS          A PROC REPORT column statement specification.       &g_trtcd &g_trtgr &g_subjid   
|                   Including spanning titles and variable names        pcstdt ptmnum pcsttm ptm 
|                   Valid values: one or more variable names from       pcsttmdv pcatmnum result (Req)
|                   DSETIN plus other elements of valid PROC REPORT    
|                   COLUMN statement syntax
|
|  ORDERVARS        List of variables that will receive the PROC        &g_trtcd &g_trtgrp &g_subjid
|                   REPORT define statement attribute ORDER Valid       pcstdt ptmnum (Req)
|                   values: one or more variable names from DSETIN      
|                   that are also defined with COLUMNS
|
|  SHARECOLVARS     List of variables that will share print space.      blank (Req)
...
|  
|  SHARECOLVARS-    Indentation factor for ShareColVars. Stacked        2 (Opt)
...
|                   are given the PROC REPORT define statement          &g_trtcd ptmnum (Req)
...
|
|  WIDTHS           Variables and width to display Valid values:        &g_subjid 7 &g_trtgrp 15
|                   values of column names and numeric widths, a        pcstdt 8 pcsttm 6
...
|                           is changed 
|
|                           FROM:  &g_trtcd &g_trtgrp &g_subjid pcstdt 
|                                   pcsttm ptm ptmnum pcsttmdv pcatmnum 
|                                   result
|
|                           TO:     &g_trtcd &g_trtgrp &g_subjid pcstdt 
|                                   ptmnum pcsttm ptm pcsttmdv pcatmnum 
|                                   result
|
|                           Order of variables specified by the ORDERVARS
|                           parameter is changed 
|
|                           FROM:  &g_trtgrp &g_subjid pcstdt ptmnum
|
|                           TO:  &g_trtcd &g_trtgrp &g_subjid pcstdt ptmnum
|
...
|  
|------------------------------------------------------------------------------------*/
%macro td_pkcl1p(dsetin                 =ardata.pkcnc /* Input PK Concentrations dataset */
                ...
                ,dddatasetlabel         =DD dataset for PKCL1P listing  /* Label to be applied to the DD dataset */
                ...
                ,columns                =&g_trtcd &g_trtgrp &g_subjid pcstdt ptmnum pcsttm ptm  pcsttmdv pcatmnum result /* Columns to be included in the listing (plus spanned headers) */
                ,ordervars              =&g_trtcd &g_trtgrp &g_subjid pcstdt ptmnum /* Order variables */
                ...
                ,noprintvars            =&g_trtcd ptmnum /* No print variables, used to order the display */
                ,byvars                 =          /* By variables */
                ,flowvars               =  /* Variables with flow option */
                ,widths                 =&g_subjid 7 &g_trtgrp 15 pcstdt 9 pcsttm 6 ptm 9 pcsttmdv 5 pcatmnum 9 result 15 /* Column widths */
                ,defaultwidths          =          /* List of default column widths */
                ,skipvars               =pcstdt /* Variable(s) whose change in value causes the display to skip a line */
