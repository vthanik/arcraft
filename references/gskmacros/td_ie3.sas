...
*  Date: 22sep2003
*
*  Macro purpose: display macro to generate IDSL ie3 listing
*
...
*                  string                                              DD dataset for IE3 listing
...
*                  COLUMN statement syntax                             &g_trtcd &g_trtgrp &g_centid &g_subjid iecrtycd iecrttyp iecrtnum ietext
...
*                  that are also defined with COLUMNS                  &g_trtcd &g_trtgrp &g_centid &g_subjid iecrtycd iecrttyp iecrtnum    
...
*                  rows in the display.                                &g_trtcd  iecrtycd iecrtnum
...
*                  width of  column header)                            ietext &g_trtgrp iecrttyp
...
*                  width, width of column header)                      &g_trtgrp 15 &g_centid 6 &g_subjid 6 iecrttyp 10 ietext 45 
...
%macro td_ie3(
   dsetin         =ardata.elig, /* Input inclusion/exclusion dataset */
   ...
   dddatasetlabel =DD dataset for IE3 listing, /* Label to be applied to the DD dataset  */
   ...
   columns        =&g_trtcd &g_trtgrp &g_centid &g_subjid iecrtycd iecrttyp iecrtnum ietext, /* Columns to be included in the listing (plus spanned headers)  */
   ordervars      =&g_trtcd &g_trtgrp &g_centid &g_subjid iecrtycd iecrttyp iecrtnum, /*  Order variables  */
   ...
   noprintvars    =&g_trtcd iecrtycd iecrtnum, /* No print variables, used to order the display */
   byvars         =,          /* By variables */
   flowvars       =ietext &g_trtgrp iecrttyp, /* Variables with flow option */
   widths         =,          /* Column widths */
   defaultwidths  =&g_trtgrp 15 &g_centid 6 &g_subjid 6 iecrttyp 10 ietext 45, /* List of default column widths */
