...
/ Date: 06OCT2003
/
/ Macro Purpose: A macro to create Medical History Display 1.
/
...
/
/COLUMNS             A PROC REPORT column statement             summaryLevel   mhbodsys tt_ac:
...
/
/DEFAULTWIDTHS       Specifies column widths for all            mhbodsys 30
...
/
/DSETINNUMER         Input dataset containing data to be        ardata.medhist
/                    counted to obtain the numerator.
/
/                    Valid Values: Valid sas dataset name
/
/FLOWVARS            Variables to be defined with the flow      mhbodsys
/                    option
/                    Valid values: one or more variable names
/                    from DSETIN that are also defined with
/                    COLUMNS
...
/                    DSETINDENOM
/
/GROUPBYVARSNUMER    Variables in DSETINNUMER to group the      &g_trtcd    mhbodsys
/                    data by, along with ACROSSVAR, when        (mhbodsys='Any Condition')
/                    counting to obtain the numerator.            mhbodsys
...
/
/IDVARS              Variables to appear on each page if the    summaryLevel mhbodsys
...
/
/NOPRINTVARS         Variables listed in the COLUMN parameter   summaryLevel
...
/                    define attribute order=internal
/
/ORDERVARS           List of variables that will receive the    summaryLevel   mhbodsys
/                    PROC REPORT define statement attribute
/                    ORDER
/                    Valid values: one or more variable names
/                    from DSETIN that are also defined with
...
%macro td_mh1 (
         ...
         columns                 =  summaryLevel   mhbodsys tt_ac:, /* Columns to be included in the listing (plus spanned headers) */
         ...
         dddatasetlabel          =  DD dataset for MH1 table,/* Label to be applied to the DD dataset */
         defaultwidths           =  mhbodsys 30,       /* List of default column widths */
         ...
         dsetinNumer             =  ardata.medhist,    /* Input dataset containing data to be counted to obtain the numerator. */
         flowvars                =  mhbodsys,          /* Variables with flow option */
         ...
         groupByVarsNumer        =  &g_trtcd (mhbodsys='Any Condition')   mhbodsys, /* Variables in DSETINNUMER to group the data by when counting to obtain the numerator. */
         idvars                  =  summaryLevel   mhbodsys, /* Variables to appear on each page of the report */
         ...
         noprintVars             =  summaryLevel,      /* No print variables, used to order the display */
         ...
         ordervars               =  summaryLevel   mhbodsys, /* Order variables */
