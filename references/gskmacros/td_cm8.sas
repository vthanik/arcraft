...
|                     Including spanning titles and variable names      tt_pct999 cmcomp  
...
|                                                                                         
| DEFAULTWIDTHS       Specifies column widths for all variables not     cmcomp 40
...
|                     obtain the numerator.                             =(display1 eq 1))
|                                                                                         
|                     Valid Values:                                                       
|                                                                                         
|                     Valid sas dataset name                                              
|                                                                                         
| FLOWVARS            Variables to be defined with the flow option      cmcomp            
|                     Valid values: one or more variable names that                       
|                     are also defined with COLUMNS                                       
...
|                     DSETINDENOM                                                         
|                                                                                         
| GROUPBYVARSNUMER    Variables in DSETINNUMER to group the data by,    &g_trtcd (cmcomp=          
|                     along with ACROSSVAR, when counting to obtain     'Any medication')  
|                     the numerator. Additionally a set of brackets     cmcomp 
...
|                     are also defined with COLUMNS                                       
|                                                                                         
| LABELS              Variables and their label for display. For use    cmcomp='Ingredient' 
...
|                     REPORT define statement attribute ORDER           tt_pct999 cmcomp      
|                     Valid values: one or more variable names that       
|                     are also defined with COLUMNS                                       
|                                                                                         
...
%macro td_cm8 (
   ...
   COLUMNS             =summaryLevel tt_pct999 cmcomp tt_ac:, /* Columns to be included in the listing (plus spanned headers) */                                                                                                           
   ...
   DEFAULTWIDTHS       =cmcomp 40 tt_ac: 12, /* List of default column widths */                                                                                                                                                                             
...
/* Input dataset containing AE data to be counted to obtain the numerator. */
   FLOWVARS            =cmcomp,            /* Variables with flow option */                                                                                                                                                                                  
   ...
   GROUPBYVARSNUMER    =&g_trtcd (cmcomp='Any medication') cmcomp, /* Variables in DSETINNUMER to group the data by when counting to obtain the numerator.*/ 
   IDVARS              = ,                 /* Variables to appear on each page of the report */                                                                                                                                                              
   LABELS              =cmcomp='Ingredient', /* Label definitions (var=var label) */                                                                                                                                                    
   ...
   ORDERVARS           =summaryLevel tt_pct999 cmcomp, /* Order variables */                                                                                                                                                                
