...
| style            Passed as %tu_pktfig parameter of the same name   INDIVIDUAL
...
|
| byvars           Passed as %tu_pktfig parameter of the same name   &g_subjid
...
%macro td_pkcf1(
  ...
  ,style = INDIVIDUAL                           /* Graph type (individual/mean/median/spaghetti) */    
  ...
  ,byvars = &g_subjid                           /* By variables (i.e. page)               */
