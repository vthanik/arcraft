# Disposition template specification — Table 14.1.3

spec_disposition <- function(data = NULL) {
  default_vars <- c("EOSSTT", "DCREASCD")
  ...
  list(
    ...
    fmt = list(
      titles = list(
        list(text = "Table 14.1.3", bold = TRUE),
        list(text = "Summary of Subject Disposition", bold = FALSE)
      ),
